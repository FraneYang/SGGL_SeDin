namespace Model
{
    ...
    public partial class SGGLDB : DataContext
    {
        ...
        //public IEnumerable<Model.ToDoItem> Sp_APP_GetToDoItems([Parameter(DbType = "nvarchar(50)")] string projectId, [Parameter(DbType = "nvarchar(50)")] string userId)
        //{
        //    IExecuteResult result = this.ExecuteMethodCall(this, ((MethodInfo)MethodInfo.GetCurrentMethod()), projectId, userId);
        //    return (ISingleResult<Model.ToDoItem>)result.ReturnValue;
        //}
