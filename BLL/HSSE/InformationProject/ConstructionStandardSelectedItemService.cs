   ...
   public static class ConstructionStandardSelectedItemService
    {
       ...
       {
           return (from x in Funs.DB.InformationProject_ConstructionStandardSelectedItem where x.ConstructionStandardIdentifyId == constructionStandardIdentifyId select x).ToList();
       }
