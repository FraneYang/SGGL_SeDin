   ...
   public static class ConstructionStandardSelectedItemService
    {
       ...
       {
           return (from x in new Model.SGGLDB(Funs.ConnString).InformationProject_ConstructionStandardSelectedItem where x.ConstructionStandardIdentifyId == constructionStandardIdentifyId select x).ToList();
       }
