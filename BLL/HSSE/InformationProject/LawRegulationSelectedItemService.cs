...
namespace BLL
{
    public class LawRegulationSelectedItemService
    {
        ...
        {
            return (from x in new Model.SGGLDB(Funs.ConnString).Law_LawRegulationSelectedItem where x.LawRegulationIdentifyId == lawRegulationIdentifyId select x).ToList();
        }
