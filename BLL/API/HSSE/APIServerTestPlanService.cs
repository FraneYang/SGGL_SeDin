...
namespace BLL
{
    ...
    public static class APIServerTestPlanService
    {
        ...
        {
            var getDataLists = (from x in new Model.SGGLDB(Funs.ConnString).Test_TestPlan
        ...
        {
            var getDataLists = (from x in new Model.SGGLDB(Funs.ConnString).Test_TestPlanTraining
