...
namespace BLL
{
    public static class APIUnitService
    {
        ...
        {
            var getUnit = new Model.SGGLDB(Funs.ConnString).Base_Unit.FirstOrDefault(x => x.UnitId == unitId);
        ...
        {
            var getData = from x in new Model.SGGLDB(Funs.ConnString).QualityAudit_SubUnitQuality
