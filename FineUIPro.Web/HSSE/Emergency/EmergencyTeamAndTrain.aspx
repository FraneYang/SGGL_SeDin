<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EmergencyTeamAndTrain.aspx.cs" Inherits="FineUIPro.Web.HSSE.Emergency.EmergencyTeamAndTrain" %>
...
<body>
    ...
    <f:Window ID="Window1" Title="应急队伍与培训" Hidden="true" EnableIFrame="true" EnableMaximize="true"
        Target="Parent" EnableResize="true" runat="server" IsModal="true" Width="1000px" Height="600px">
    </f:Window>
