    ...
    public partial class SpecialScheme : PageBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                btnSelectColumns.OnClientClick = Window4.GetShowReference("SpecialSchemeSelectCloumn.aspx");
        ...
        {
            string strSql = @"SELECT SpecialSchemeId,SpecialSchemeTypeId,SpecialSchemeCode,SpecialSchemeName,UnitId,CompileMan,CompileDate,AttachUrl
                                            , Summary, AuditMan, AuditDate, IsPass, IsBuild, UpState, AuditManName, UnitName, SpecialSchemeTypeCode, SpecialSchemeTypeName, AttachUrlName, IsBuildName
                                            FROM dbo.View_Technique_SpecialScheme
                                            WHERE 1 =1 ";
