<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CompanyHazardList.aspx.cs" Inherits="FineUIPro.Web.HSSE.Technique.CompanyHazardList" %>
            ...
            <f:Panel runat="server" ID="panelLeftRegion" RegionPosition="Left" RegionSplit="true"
                ...
                <Toolbars>
                    <f:Toolbar ID="Toolbar1" Position="Top" ToolbarAlign="Right" runat="server">
                        <Items>
                            <f:TextBox ID="txtHazardListType" runat="server" LabelAlign="Right"  Width="180px"
                                EmptyText="输入查询条件">
                            </f:TextBox>
                ...
                <Items>
                    <f:Tree ID="trHazardListType" Width="220px" EnableCollapse="true" ShowHeader="false"
            ...
            <f:Panel runat="server" ID="panelCenterRegion" RegionPosition="Center" ShowBorder="true"
                ...
                <Items>
                    <f:Grid ID="Grid1" Width="870px" ShowBorder="true" ShowHeader="false" EnableCollapse="true"
                        ...
                        SortField="HazardCode" SortDirection="ASC" ForceFit="true"
                       ...
                       EnableTextSelection="True">
                        ...
                        <Columns>
                            ...
                            <%--<f:TemplateField Width="60px" HeaderText="类别编号" HeaderTextAlign="Center" TextAlign="Left"
                            ...
                            <f:RenderField Width="60px" ColumnID="HazardLevel" DataField="HazardLevel" SortField="HazardLevel"
