<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AccidentReportOther.aspx.cs"
    Inherits="FineUIPro.Web.HSSE.Accident.AccidentReportOther" %>
    ...
    <f:Panel ID="Panel1" runat="server" Margin="5px" BodyPadding="5px" ShowBorder="false"
        ...
        <Items>
            <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" Title="事故调查处理报告" EnableCollapse="true"
                ...
                DataIDField="AccidentReportOtherId" AllowSorting="true" SortField="AccidentReportOtherCode" SortDirection="DESC"
                ...
                <Columns>
                    <f:RowNumberField EnablePagingNumber="true" HeaderText="序号" Width="50px" HeaderTextAlign="Center"
                        TextAlign="Center" />
                    <f:RenderField Width="80px" ColumnID="AccidentReportOtherCode" DataField="AccidentReportOtherCode"
                        SortField="AccidentReportOtherCode" FieldType="String" HeaderText="编号" HeaderTextAlign="Center"
                        TextAlign="Left">
                    </f:RenderField>
                    <f:RenderField Width="120px" ColumnID="AccidentTypeName" DataField="AccidentTypeName"
                        SortField="AccidentTypeName" FieldType="String" HeaderText="类型" HeaderTextAlign="Center"
                        TextAlign="Left">
                    </f:RenderField>
                    ...
                    <%--<f:RenderField Width="90px" ColumnID="EconomicLoss" DataField="EconomicLoss" SortField="EconomicLoss"
