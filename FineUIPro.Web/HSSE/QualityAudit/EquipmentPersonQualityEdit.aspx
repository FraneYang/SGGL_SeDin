<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EquipmentPersonQualityEdit.aspx.cs"
    Inherits="FineUIPro.Web.HSSE.QualityAudit.EquipmentPersonQualityEdit" ValidateRequest="false" %>
...
<body>
    ...
    <f:Form ID="SimpleForm1" ShowBorder="false" ShowHeader="false" Title="人员资质" AutoScroll="true"
        ...
        <Rows>
            ...
            <f:FormRow>
                <Items>
                   <f:TextBox ID="txtPersonName" runat="server" Label="姓名" LabelAlign="Right" Readonly="true" LabelWidth="120px">
                    </f:TextBox>
