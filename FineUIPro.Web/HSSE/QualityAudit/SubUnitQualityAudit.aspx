<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SubUnitQualityAudit.aspx.cs" Inherits="FineUIPro.Web.HSSE.QualityAudit.SubUnitQualityAudit" %>
            ...
            <f:FormRow>
                <Items>
                    <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" runat="server" 
                        ...
                        ShowGridHeader="true" Height="400px" EnableColumnLines="true"  ForceFit="true"
                        ...
                        <Columns>
                            ...
                            <f:WindowField TextAlign="Left" Width="60px" WindowID="WindowAtt" HeaderTextAlign="Center"
                                Text="详细" HeaderText="附件" ToolTip="附件上传查看" DataIFrameUrlFields="AuditDetailId" DataIFrameUrlFormatString="../../AttachFile/webuploader.aspx?toKeyId={0}&path=FileUpload/SubUnitQualityAuditAttachUrl&menuId=DFDFEDA3-FECB-40DA-9216-C67B48002A8A&type=-1" />
                        </Columns>
                        <Listeners>
