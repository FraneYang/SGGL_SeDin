<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TrainTest.aspx.cs" Inherits="FineUIPro.Web.HSSE.EduTrain.TrainTest" %>
        ...
        <f:Panel ID="Panel1" runat="server" Margin="5px" BodyPadding="5px" Title="培训试题" Layout="Fit"
            ...
            <Items>
                <f:Grid ID="Grid1" Title="培训试题" ShowHeader="false" EnableCollapse="true" PageSize="500"
                    ...
                    DataIDField="TrainTestId" SortField="COrder" SortDirection="ASC" ForceFit="true"
