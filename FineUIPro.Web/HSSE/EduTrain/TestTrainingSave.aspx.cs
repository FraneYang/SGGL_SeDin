...
namespace FineUIPro.Web.HSSE.EduTrain
{
    public partial class TestTrainingSave : PageBase
    {
        ...
        {
            var standard = new Model.SGGLDB(Funs.ConnString).Training_TestTraining.FirstOrDefault(x => x.TrainingName == this.txtTrainingName.Text.Trim() && (x.TrainingId != this.TrainingId || (this.TrainingId == null && x.TrainingId != null)));
            if (standard != null)
            {
