            ...
            <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" Title="班前会" EnableCollapse="true"
                ...
                <Toolbars>
                    <f:Toolbar ID="Toolbar2" Position="Top" runat="server" ToolbarAlign="Left">
                        <Items>
                            <f:TextBox runat="server" Label="编号" ID="txtClassMeetingCode" EmptyText="输入查询条件"
                            ...
                            <f:TextBox runat="server" Label="名称" ID="txtClassMeetingName" EmptyText="输入查询条件"
                                AutoPostBack="true" OnTextChanged="TextBox_TextChanged" Width="250px" LabelWidth="80px"
                                LabelAlign="right">
                            </f:TextBox>
                ...
                <Columns>
                    ...
                    <f:RenderField Width="140px" ColumnID="ClassMeetingCode" DataField="ClassMeetingCode"
                        SortField="ClassMeetingCode" FieldType="String" HeaderText="编号" HeaderTextAlign="Center"
                        TextAlign="Left">
                    </f:RenderField>
                    <f:RenderField Width="150px" ColumnID="ClassMeetingName" DataField="ClassMeetingName"
                        SortField="ClassMeetingName" FieldType="String" HeaderText="名称" HeaderTextAlign="Center"
                        TextAlign="Left">
                    </f:RenderField>
