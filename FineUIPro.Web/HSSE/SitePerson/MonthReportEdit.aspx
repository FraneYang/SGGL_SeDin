<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MonthReportEdit.aspx.cs" Inherits="FineUIPro.Web.HSSE.SitePerson.MonthReportEdit" %>
...
<body>
    ...
    <f:Form ID="SimpleForm1" ShowBorder="false" ShowHeader="false" AutoScroll="true"
        ...
        <Rows>
            ...
            <f:FormRow>
                <Items>
                    <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" runat="server"  DataIDField="MonthReportDetailId"
                        DataKeyNames="MonthReportDetailId" ShowGridHeader="true" Height="300px" ForceFit="true"
                        ...
                        <Columns>                           
                            ...
                            <f:RenderField Width="250px" ColumnID="StaffData" DataField="StaffData" SortField="StaffData"
