...
#pragma warning restore CS0108 // “DayReport.GetGridTableHtml(Grid)”隐藏继承的成员“PageBase.GetGridTableHtml(Grid)”。如果是有意隐藏，请使用关键字 new。
        ...
        protected void btnView_Click(object sender, EventArgs e)
        {
            ...
            PageContext.RegisterStartupScript(Window1.GetShowReference(String.Format("DayReportView.aspx?CompileDate={0}&ProjectId={1}", Grid1.SelectedRowID, this.ProjectId, "查看 - ")));
        }
    }
}