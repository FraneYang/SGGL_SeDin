<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GeneralEquipmentInView.aspx.cs"
    Inherits="FineUIPro.Web.HSSE.InApproveManager.GeneralEquipmentInView" %>
...
<body>
    ...
    <f:Form ID="SimpleForm1" ShowBorder="false" ShowHeader="false" AutoScroll="true"
        ...
        <Rows>
            <f:FormRow>
                <Items>
                    <f:TextBox ID="txtGeneralEquipmentInCode" runat="server" Label="编号" LabelAlign="Right" LabelWidth="90px"
                        Readonly="true">
                    </f:TextBox>
                    <f:TextBox ID="txtUnitName" runat="server" Label="单位名称" LabelAlign="Right" Readonly="true" LabelWidth="90px">
                    </f:TextBox>
                    <f:TextBox ID="txtCarNumber" runat="server" Label="车牌号" LabelAlign="Right" Readonly="true" LabelWidth="90px">
                    </f:TextBox>
            ...
            <f:FormRow>
                <Items>
                    <f:TextArea ID="txtContentDef" runat="server" Label="施工内容简述" LabelAlign="Right" Readonly="true" LabelWidth="110px"
                        Height="60px">
                    </f:TextArea>
                     <f:TextArea ID="txtOtherDef" runat="server" Label="其它情况简述" LabelAlign="Right" Readonly="true" LabelWidth="110px"
                        Height="60px">
                    </f:TextArea>
                </Items>
            </f:FormRow>
            <f:FormRow>
                <Items>
                    <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" Title="主要设备基本情况" EnableCollapse="true"
                        ...
                        DataIDField="GeneralEquipmentInItemId" EnableTextSelection="True" Height="220px">
                        <Toolbars>
