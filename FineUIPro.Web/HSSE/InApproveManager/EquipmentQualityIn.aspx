<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EquipmentQualityIn.aspx.cs" Inherits="FineUIPro.Web.HSSE.InApproveManager.EquipmentQualityIn" %>
    ...
    <f:Panel ID="Panel1" runat="server" Margin="5px" BodyPadding="5px" ShowBorder="false"
        ...
        <Items>
            <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" Title="特种设备审批" EnableCollapse="true"
                runat="server" BoxFlex="1" EnableColumnLines="true" DataKeyNames="EquipmentQualityInId" ForceFit="true"
                DataIDField="EquipmentQualityInId" AllowSorting="true" SortField="CompileDate" SortDirection="DESC" OnSort="Grid1_Sort"
                ...
                <Columns>
                    ...
                    <f:RenderField Width="150px" ColumnID="DriverName" DataField="DriverName" SortField="DriverName"
                        FieldType="String" HeaderText="司机" HeaderTextAlign="Center" TextAlign="Left">
                    </f:RenderField>
