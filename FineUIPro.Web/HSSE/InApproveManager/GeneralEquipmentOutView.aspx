<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GeneralEquipmentOutView.aspx.cs"
    Inherits="FineUIPro.Web.HSSE.InApproveManager.GeneralEquipmentOutView" %>
            ...
            <Rows>
                <f:FormRow ColumnWidths="25% 50% 25%">
                    <Items>
                        ...
                        <f:TextBox ID="txtUnitName" runat="server" Label="申请单位" LabelAlign="Right" Readonly="true" LabelWidth="90px">
                        </f:TextBox>
                        <f:TextBox ID="txtApplicationDate" runat="server" Label="申请日期" LabelAlign="Right" LabelWidth="90px"
                            Readonly="true">
                        </f:TextBox>
                    </Items>
                </f:FormRow>
                <f:FormRow>
                    <Items>
                        <f:TextBox ID="txtCarNum" runat="server" Label="车牌号" LabelAlign="Right" Readonly="true" LabelWidth="90px">
                        </f:TextBox>
                        <f:TextBox ID="txtCarModel" runat="server" Label="车型" LabelAlign="Right" Readonly="true" LabelWidth="90px">
                        </f:TextBox>
                        <f:TextBox ID="txtDriverName" runat="server" Label="驾驶员" LabelAlign="Right" Readonly="true" LabelWidth="90px">
                        </f:TextBox>
                        <f:TextBox ID="txtDriverNum" runat="server" Label="驾驶证号" LabelAlign="Right" Readonly="true" LabelWidth="90px">
                        </f:TextBox>
                    </Items>
                </f:FormRow>
                ...
                <f:FormRow>
                    <Items>
                        <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" Title="出场机具设备清单" EnableCollapse="true"
                            ...
                            DataIDField="GeneralEquipmentOutItemId" AllowPaging="true" IsDatabasePaging="true" PageSize="10" OnPageIndexChange="Grid1_PageIndexChange"
