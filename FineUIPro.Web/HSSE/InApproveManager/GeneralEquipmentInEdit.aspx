<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GeneralEquipmentInEdit.aspx.cs"
    Inherits="FineUIPro.Web.HSSE.InApproveManager.GeneralEquipmentInEdit" ValidateRequest="false" %>
...
<body>
    ...
    <f:Form ID="SimpleForm1" ShowBorder="false" ShowHeader="false" AutoScroll="true"
        ...
        <Rows>
            <f:FormRow>
                <Items>
                    <f:TextBox ID="txtGeneralEquipmentInCode" runat="server" Label="编号" LabelAlign="Right" LabelWidth="80px"
            ...
            <f:FormRow>
                <Items>
                    <f:TextArea ID="txtContentDef" runat="server" Label="施工内容简述" LabelAlign="Right" MaxLength="500"  LabelWidth="110px"
                        Height="60px">
                    </f:TextArea>
                    <f:TextArea ID="txtOtherDef" runat="server" Label="其它情况简述" LabelAlign="Right" MaxLength="500"  LabelWidth="110px"
                        Height="60px">
                    </f:TextArea>
                </Items>
            </f:FormRow>
            <f:FormRow>
                <Items>
                    <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" Title="主要设备基本情况" EnableCollapse="true"
                       ...
                       DataIDField="GeneralEquipmentInItemId" AllowPaging="true" IsDatabasePaging="true" PageSize="10" OnPageIndexChange="Grid1_PageIndexChange"
