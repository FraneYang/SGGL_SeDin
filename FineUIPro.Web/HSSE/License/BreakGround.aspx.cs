    ...
    public partial class BreakGround : PageBase
    {
        ...
        protected void btnPrinter_Click(object sender, EventArgs e)
        {
            ...
            if (bookmarkLicenseCode != null)
            {
                ...
                {
                    bookmarkLicenseCode.Text = getBreakGround.LicenseCode;
                }
            }
            ...
            if (bookmarkApplyManName != null)
            {
                if (getBreakGround != null)
                {
                    var getUser = UserService.GetUserByUserId(getBreakGround.ApplyManId);
                    if (getUser != null)
                    {
            ...
            if (bookmarkUnitName != null)
            {
                if (getBreakGround != null)
                {
                    if (!string.IsNullOrEmpty(getBreakGround.ApplyUnitId))
                    {
                        bookmarkUnitName.Text = BLL.UnitService.GetUnitNameByUnitId(getBreakGround.ApplyUnitId);
                    }
            ...
            if (bookmarkValidityDate != null)
            {
                if (getBreakGround != null)
                {
                    if (getBreakGround.ValidityStartTime.HasValue)
                    {
                        ...
                        bookmarkValidityDate.Text = getBreakGround.ValidityStartTime.Value.Year + "年" + getBreakGround.ValidityStartTime.Value.Month + "月" + getBreakGround.ValidityStartTime.Value.Day + "日" + getBreakGround.ValidityStartTime.Value.Hour + "时至";
                        if (getBreakGround.ValidityEndTime.HasValue)
                        {
                            bookmarkValidityDate.Text += getBreakGround.ValidityEndTime.Value.Year + "年" + getBreakGround.ValidityEndTime.Value.Month + "月" + getBreakGround.ValidityEndTime.Value.Day + "日" + getBreakGround.ValidityEndTime.Value.Hour + "时";
                        }
                    }
                }
            }
            ...
            if (bookmarkWorkMeasures != null)
            {
                if (getBreakGround != null)
                {
                    bookmarkWorkMeasures.Text = getBreakGround.WorkMeasures;
            ...
            if (bookmarkCance != null)
            {
                if (getBreakGround != null)
                {
                    ...
                    {
                        var getUser = UserService.GetUserByUserId(getBreakGround.CancelManId);
                        if (getUser != null)
                        {
                            if (!string.IsNullOrEmpty(getUser.SignatureUrl) && File.Exists(rootPath + getUser.SignatureUrl))
                            {
                                ...
                                builders.InsertImage(file, 80, 20);
                                builders.Write("取消原因：" + getBreakGround.CancelReasons + "  取消时间：" + string.Format("{0:yyyy-MM-dd HH:mm}", getBreakGround.CancelTime));
                            }
                            else
                            {
                                bookmarkCance.Text = getUser.UserName + "  取消原因：" + getBreakGround.CancelReasons + "  取消时间：" + string.Format("{0:yyyy-MM-dd HH:mm}", getBreakGround.CancelTime);
                            }
                        }
                    }
                }
                    ...
                    if (!string.IsNullOrEmpty(getBreakGround.CloseManId))
                    {
                        ...
                        if (getUser != null)
                        {
                            ...
                            else if (!string.IsNullOrEmpty(getUser.SignatureUrl) && File.Exists(rootPath + getUser.SignatureUrl))
                            {
                                ...
                                builders.InsertImage(file, 80, 20);
                                builders.Write("关闭时间：" + string.Format("{0:yyyy-MM-dd HH:mm}", getBreakGround.CloseTime));
                            }
                            else
                            {
                                bookmarkClose.Text = getUser.UserName + "  关闭时间：" + string.Format("{0:yyyy-MM-dd HH:mm}", getBreakGround.CloseTime);
                            }
                        }
                    }
                }
