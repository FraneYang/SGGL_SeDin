...
namespace FineUIPro.Web.HSSE.License
{
    public partial class OpenCircuit : PageBase
    {
        ...
        protected void btnPrinter_Click(object sender, EventArgs e)
        {
            ...
            initTemplatePath = "File\\Word\\HSSE\\断路（占道）作业票.doc";
            ...
            ///更新书签
            var getOpenCircuit = LicensePublicService.GetOpenCircuitById(Id);
            ...
            if (bookmarkLicenseCode != null)
            {
                ...
                {
                    bookmarkLicenseCode.Text = getOpenCircuit.LicenseCode;
                }
            }
            ...
            if (bookmarkApplyManName != null)
            {
                if (getOpenCircuit != null)
                {
                    var getUser = UserService.GetUserByUserId(getOpenCircuit.ApplyManId);
                    if (getUser != null)
                    {
            ...
            if (bookmarkUnitName != null)
            {
                if (getOpenCircuit != null)
                {
                    if (!string.IsNullOrEmpty(getOpenCircuit.ApplyUnitId))
                    {
                        bookmarkUnitName.Text = BLL.UnitService.GetUnitNameByUnitId(getOpenCircuit.ApplyUnitId);
                    }
            ...
            if (bookmarkWorkPalce != null)
            {
                if (getOpenCircuit != null)
                {
                    bookmarkWorkPalce.Text = getOpenCircuit.WorkPalce;
            ...
            if (bookmarkWorkMeasures != null)
            {
                if (getOpenCircuit != null)
                {
                    bookmarkWorkMeasures.Text = getOpenCircuit.WorkMeasures;
            ...
            if (bookmarkValidityDate != null)
            {
                if (getOpenCircuit != null)
                {
                    if (getOpenCircuit.ValidityStartTime.HasValue)
                    {
                        ...
                        bookmarkValidityDate.Text = getOpenCircuit.ValidityStartTime.Value.Year + "年" + getOpenCircuit.ValidityStartTime.Value.Month + "月" + getOpenCircuit.ValidityStartTime.Value.Day + "日" + getOpenCircuit.ValidityStartTime.Value.Hour + "时至";
                        if (getOpenCircuit.ValidityEndTime.HasValue)
                        {
                            bookmarkValidityDate.Text += getOpenCircuit.ValidityEndTime.Value.Year + "年" + getOpenCircuit.ValidityEndTime.Value.Month + "月" + getOpenCircuit.ValidityEndTime.Value.Day + "日" + getOpenCircuit.ValidityEndTime.Value.Hour + "时";
                        }
                    }
                }
            }
            Bookmark bookmarkRoadName = doc.Range.Bookmarks["RoadName"];//占用道路名称
            if (bookmarkRoadName != null)
            {
                if (getOpenCircuit != null)
                {
                    bookmarkRoadName.Text = getOpenCircuit.RoadName;

                }
            }
            Bookmark bookmarkSafeMeasures = doc.Range.Bookmarks["SafeMeasures"];//安全措施
            if (bookmarkSafeMeasures != null)
            {
                if (getOpenCircuit != null)
                {
                    bookmarkSafeMeasures.Text = getOpenCircuit.SafeMeasures;
            ...
            if (bookmarkCance != null)
            {
                if (getOpenCircuit != null)
                {
                    ...
                    {
                        var getUser = UserService.GetUserByUserId(getOpenCircuit.CancelManId);
                        if (getUser != null)
                        {
                            if (!string.IsNullOrEmpty(getUser.SignatureUrl) && File.Exists(rootPath + getUser.SignatureUrl))
                            {
                                ...
                                builders.InsertImage(file, 80, 20);
                                builders.Write("取消原因：" + getOpenCircuit.CancelReasons + "  取消时间：" + string.Format("{0:yyyy-MM-dd HH:mm}", getOpenCircuit.CancelTime));
                            }
                            else
                            {
                                bookmarkCance.Text = getUser.UserName + "  取消原因：" + getOpenCircuit.CancelReasons + "  取消时间：" + string.Format("{0:yyyy-MM-dd HH:mm}", getOpenCircuit.CancelTime);
                            }
                        }
                    }
                }
            ...
            if (bookmarkClose != null)
            {
                if (getOpenCircuit != null)
                {
                    ...
                    {
                        var getUser = UserService.GetUserByUserId(getOpenCircuit.CloseManId);
                        if (getUser != null)
                        {
                            if (!string.IsNullOrEmpty(getOpenCircuit.CloseReasons))
                            {
                                bookmarkClose.Text = getOpenCircuit.CloseReasons + " 关闭时间："
                            ...
                            else if (!string.IsNullOrEmpty(getUser.SignatureUrl) && File.Exists(rootPath + getUser.SignatureUrl))
                            {
                                ...
                                builders.InsertImage(file, 80, 20);
                                builders.Write("关闭时间：" + string.Format("{0:yyyy-MM-dd HH:mm}", getOpenCircuit.CloseTime));
                            }
                            else
                            {
                                bookmarkClose.Text = getUser.UserName + "  关闭时间：" + string.Format("{0:yyyy-MM-dd HH:mm}", getOpenCircuit.CloseTime);
                            }
                        }
                    }
                }
