...
namespace FineUIPro.Web.HSSE.License
{
    public partial class HeightWork : PageBase
    {
        ...
        protected void btnPrinter_Click(object sender, EventArgs e)
        {
            ...
            initTemplatePath = "File\\Word\\HSSE\\高处作业票.doc";
            ...
            ///更新书签
            var getHeightWork = LicensePublicService.GetHeightWorkById(Id);
            ...
            if (bookmarkLicenseCode != null)
            {
                ...
                {
                    bookmarkLicenseCode.Text = getHeightWork.LicenseCode;
                }
            }
            ...
            if (bookmarkUnitName != null)
            {
                if (getHeightWork != null)
                {
                    if (!string.IsNullOrEmpty(getHeightWork.ApplyUnitId))
                    {
                        bookmarkUnitName.Text = BLL.UnitService.GetUnitNameByUnitId(getHeightWork.ApplyUnitId);
                    }
            ...
            if (bookmarkWorkPalce != null)
            {
                if (getHeightWork != null)
                {
                    bookmarkWorkPalce.Text = getHeightWork.WorkPalce;
            ...
            if (bookmarkValidityDate != null)
            {
                if (getHeightWork != null)
                {
                    if (getHeightWork.ValidityStartTime.HasValue)
                    {
                        ...
                        bookmarkValidityDate.Text = getHeightWork.ValidityStartTime.Value.Year + "年" + getHeightWork.ValidityStartTime.Value.Month + "月" + getHeightWork.ValidityStartTime.Value.Day + "日" + getHeightWork.ValidityStartTime.Value.Hour + "时至";
                        if (getHeightWork.ValidityEndTime.HasValue)
                        {
                            bookmarkValidityDate.Text += getHeightWork.ValidityEndTime.Value.Year + "年" + getHeightWork.ValidityEndTime.Value.Month + "月" + getHeightWork.ValidityEndTime.Value.Day + "日" + getHeightWork.ValidityEndTime.Value.Hour + "时";
                        }
                    }
                }
            }
            ...
            if (bookmarkWorkMeasures != null)
            {
                if (getHeightWork != null)
                {
                    bookmarkWorkMeasures.Text = getHeightWork.WorkMeasures;
            ...
            if (bookmarkCance != null)
            {
                if (getHeightWork != null)
                {
                    ...
                    {
                        var getUser = UserService.GetUserByUserId(getHeightWork.CancelManId);
                        if (getUser != null)
                        {
                            if (!string.IsNullOrEmpty(getUser.SignatureUrl) && File.Exists(rootPath + getUser.SignatureUrl))
                            {
                            ...
                            {
                                bookmarkCance.Text = getUser.UserName + "  取消原因：" + getHeightWork.CancelReasons + "  取消时间：" + string.Format("{0:yyyy-MM-dd HH:mm}", getHeightWork.CancelTime);
                            }
                        }
                    }
                }
            ...
            if (bookmarkClose != null)
            {
                if (getHeightWork != null)
                {
                    ...
                    {
                        var getUser = UserService.GetUserByUserId(getHeightWork.CloseManId);
                        if (getUser != null)
                        {
                            if (!string.IsNullOrEmpty(getUser.SignatureUrl) && File.Exists(rootPath + getUser.SignatureUrl))
                            {
                            ...
                            {
                                bookmarkClose.Text = getUser.UserName + "  关闭时间：" + string.Format("{0:yyyy-MM-dd HH:mm}", getHeightWork.CloseTime);
                            }
                        }
                    }
                }
