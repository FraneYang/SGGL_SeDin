<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AccidentCauseReportEdit.aspx.cs"
    Inherits="FineUIPro.Web.HSSE.InformationProject.AccidentCauseReportEdit" ValidateRequest="false" %>
...
<body>
    ...
    <f:Form ID="SimpleForm1" ShowBorder="false" ShowHeader="false" AutoScroll="true"
        ...
        <Rows>
          ...
          <f:FormRow ColumnWidths="15% 25% 30% 30%">
                <Items>
            ...
            <f:FormRow>
                <Items>
                    <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" EnableCollapse="true" runat="server"
                        ...
                        EnableHeaderMenu="false" Width="1200px" Height="300px">
                        <Columns>
