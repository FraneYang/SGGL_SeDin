<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DrillConductedQuarterlyReport.aspx.cs" Inherits="FineUIPro.Web.HSSE.InformationProject.DrillConductedQuarterlyReport" ValidateRequest="false" %>
    ...
    <f:Panel ID="Panel1" runat="server" Margin="5px" BodyPadding="5px" ShowBorder="false"
        ...
        <Items>
            <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" Title="应急演练开展情况季报" EnableCollapse="true"
                ...
                DataIDField="DrillConductedQuarterlyReportId" AllowSorting="true" ForceFit="true"
