<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Picture.aspx.cs" Inherits="FineUIPro.Web.PZHGL.InformationProject.Picture" %>
<!DOCTYPE html>
<html>
<head runat="server">
    <title>项目图片</title>
    ...
    <f:Panel ID="Panel1" runat="server" Margin="5px" BodyPadding="5px" ShowBorder="false"
        ...
        <Items>
            <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" Title="项目图片" EnableCollapse="true"
                runat="server" BoxFlex="1" EnableColumnLines="true" DataKeyNames="PictureId" DataIDField="PictureId" 
                AllowSorting="true" SortField="Code" SortDirection="DESC" OnSort="Grid1_Sort" AllowPaging="true"
                ...
                <Columns>                                      
                    ...
                    <f:RenderField Width="250px" ColumnID="Title" DataField="Title" SortField="Title" 
                        FieldType="String" HeaderText="标题" HeaderTextAlign="Center" TextAlign="Left">
                    </f:RenderField>
                     <f:RenderField Width="100px" ColumnID="PictureTypeName" DataField="PictureTypeName"
                         SortField="PictureTypeName"
                ...
                <%--     <f:RenderField Width="90px" ColumnID="CompileManName" DataField="CompileManName"
                  ...
                  <%--  <f:WindowField TextAlign="Left" Width="70px" WindowID="WindowAtt" HeaderTextAlign="Center"
                        Text="详细" HeaderText="附件" ToolTip="附件查看" DataIFrameUrlFields="PictureId" DataIFrameUrlFormatString="~/AttachFile/webuploader.aspx?toKeyId={0}&type=-1&path=FileUpload/PictureAttachUrl&menuId=B58179BE-FE6E-4E91-84FC-D211E4692354"/>--%>
                </Columns>
                <Listeners>
