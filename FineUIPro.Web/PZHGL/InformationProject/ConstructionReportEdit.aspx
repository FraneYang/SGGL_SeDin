<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ConstructionReportEdit.aspx.cs" Inherits="FineUIPro.Web.PZHGL.InformationProject.ConstructionReportEdit" ValidateRequest="false" %>
    ...
    <form id="form1" runat="server">
        ...
        <f:Form ID="SimpleForm1" ShowBorder="false" ShowHeader="false" AutoScroll="true"
            ...
            <Rows>
                <f:FormRow>
                    <Items>
                        <f:ContentPanel ID="ContentPanel2" Title="总承包商施工报告" ShowBorder="true"
                                ...
                                <Rows>
                                    ...
                                    <f:FormRow>
                                        <Items>
                                            ...
                                            <f:DropDownList ID="drpFileType" runat="server" Label="文件类型" LabelAlign="Right" EnableEdit="true">
                                </f:DropDownList>
                ...
                <f:FormRow ID="next">
                    <Items>
                        <f:ContentPanel ID="ContentPanel5" Title="总承包商施工报告审批流程设置" runat="server" ShowHeader="true" EnableCollapse="true"
                            BodyPadding="0px">
                ...
                <f:FormRow ID="plApprove2">
                    <Items>
                        <f:ContentPanel Title="总承包商施工报告审批列表" ShowBorder="true"
                            BodyPadding="10px" EnableCollapse="true" ShowHeader="true" AutoScroll="true"
                            runat="server">
                            <f:Grid ID="Grid1" IsFluid="true" CssClass="blockpanel" ShowBorder="true" ShowHeader="false" runat="server" EnableCollapse="false"
                                DataKeyNames="ConstructionReportApproveId" EnableColumnLines="true" ForceFit="true">
                                <Columns>
                                    ...
                                    <f:TemplateField ColumnID="State" Width="250px" HeaderText="办理类型" HeaderTextAlign="Center" TextAlign="Center"
                                        ...
                                        <ItemTemplate>
                                            <asp:Label ID="Label1" runat="server" Text='<%# BLL.ConstructionReportService.ConvertState(Eval("ApproveType")) %>'></asp:Label>
                                        </ItemTemplate>
                                    </f:TemplateField>
