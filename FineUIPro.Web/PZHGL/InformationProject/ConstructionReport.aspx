<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ConstructionReport.aspx.cs" Inherits="FineUIPro.Web.PZHGL.InformationProject.ConstructionReport" %>
    ...
    <form id="form1" runat="server">
        ...
        <f:panel id="Panel1" runat="server" margin="5px" bodypadding="5px" showborder="false"
            ...
            <Items>
                ...
                <f:Grid ID="Grid1" ShowBorder="true" EnableAjax="false" ShowHeader="false" Title="总承包商施工报告" EnableCollapse="true"
                    runat="server" BoxFlex="1" DataKeyNames="ConstructionReportId" AllowCellEditing="true"
                    ClicksToEdit="2" DataIDField="ConstructionReportId" AllowSorting="true" SortField="Code"
                   ...
                   EnableTextSelection="True">
                    <Toolbars>
                        ...
                        <f:Toolbar ID="Toolbar2" Position="Top" runat="server" ToolbarAlign="Left">
                            <Items>
                                ...
                                <f:DropDownList ID="drpFileType" runat="server" Label="文件类型" LabelAlign="Right" EnableEdit="true" AutoPostBack="true" OnSelectedIndexChanged="TextBox_TextChanged">
                                </f:DropDownList>
                    ...
                    <Columns>
                        ...
                        <f:TemplateField ColumnID="FileType" Width="100px" HeaderText="文件类型" HeaderTextAlign="Center" TextAlign="Center"
                            EnableLock="true" Locked="False">
                            <ItemTemplate>
                                <asp:Label ID="Label2" runat="server" Text='<%# BLL.ConstructionReportService.ConvertFileType(Eval("FileType")) %>'></asp:Label>
                            </ItemTemplate>
                        </f:TemplateField>
                        ...
                        <f:TemplateField ColumnID="State" Width="100px" HeaderText="审批状态" HeaderTextAlign="Center" TextAlign="Center"
                            EnableLock="true" Locked="False">
                            <ItemTemplate>
                                <asp:Label ID="Label1" runat="server" Text='<%# BLL.ConstructionReportService.ConvertState(Eval("State")) %>'></asp:Label>
                            </ItemTemplate>
                        </f:TemplateField>
                        <f:TemplateField ColumnID="AuditMan" Width="60px" HeaderText="办理人" HeaderTextAlign="Center" TextAlign="Center"
                            EnableLock="true" Locked="False">
                            <ItemTemplate>
                                <asp:Label ID="Label41" runat="server" Text='<%# BLL.ConstructionReportService.ConvertMan(Eval("ConstructionReportId")) %>'></asp:Label>
                            </ItemTemplate>
                        </f:TemplateField>
           ...
           <f:Window ID="window_tt" Title="总承包商施工报告" Hidden="true" EnableIFrame="true" EnableMaximize="true"
