<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ConstructionReportView.aspx.cs" Inherits="FineUIPro.Web.PZHGL.InformationProject.ConstructionReportView" ValidateRequest="false" %>
                                ...
                                <Rows>
                                    ...
                                    <f:FormRow>
                                        <Items>
                                            ...
                                            <f:TextBox ID="txtFileType" runat="server" Readonly="true" Label="文件类型" LabelAlign="Right"
                                                MaxLength="50">
                                            </f:TextBox>
