    ...
    public partial class PersonCheck : PageBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                Funs.FineUIPleaseSelect(this.drpState, "请选择");
                BindGrid();
        ...
        private void BindGrid()
        {
            ...
            if (drpState.SelectedValue != BLL.Const._Null && drpState.SelectedValue != null)
            {
                ...
                if (GetQuarterCheck != null)
                {
                    ...
                    if (GetCheckItemList.Count > 0)
                    {
                        ...
                        foreach (var approve in approves)
                        {
                            ...
                            if (projectUser != null)
                            {
                                if (projectUser.RoleId.Contains(BLL.Const.ConstructionManager))
                                {
                                ...
                                else if (projectUser.RoleId.Contains(BLL.Const.ProjectManager))
                                {
                                    if (approve.ApproveDate != null)
                                    {
                                ...
                                else if (projectUser.RoleId.Contains(BLL.Const.HSSEManager))
                                {
                                    if (approve.ApproveDate != null)
                                    {
                                ...
                                else if (projectUser.RoleId.Contains(BLL.Const.QAManager))
                                {
                                    if (approve.ApproveDate != null)
                                    {
                                ...
                                else if (projectUser.RoleId.Contains(BLL.Const.TestManager))
                                {
                                    if (approve.ApproveDate != null)
                                    {
        ...
        protected void btnOut_Click(object sender, EventArgs e)
        {
            ...
            string newUrl = string.Empty;
            string filePath = string.Empty;
            string outFilePath = rootPath + "File\\Word\\Person\\员工考核";
            ...
            string startPath = rootPath + "File\\Word\\Person\\员工考核";
            string zipPath = rootPath + "File\\Word\\Person\\员工考核.zip";
