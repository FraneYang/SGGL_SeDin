                            ...
                            <Rows>
                                <f:FormRow ColumnWidths="30% 30% 30% 5%">
                                    <Items>
                                        ...
                                        <f:DropDownList ID="drpWorkPost" runat="server" Label="岗位" EnableEdit="true" AutoPostBack="true" OnSelectedIndexChanged="drpWorkPost_SelectedIndexChanged">
                                        </f:DropDownList>
                                    </Items>
                                </f:FormRow>
                                <f:FormRow>
                                    <Items>
                                        <f:Grid ID="gvPerson" ShowBorder="true" ShowHeader="false" EnableCollapse="true" EnableColumnLines="true"
                                            EnableColumnMove="true" runat="server" BoxFlex="1" DataKeyNames="UserId,WorkPostId"
                                            DataIDField="UserId" AllowSorting="true" ForceFit="true" PageSize="1000"
