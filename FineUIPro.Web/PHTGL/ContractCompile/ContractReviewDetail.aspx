...
<body>
    <form id="form1" runat="server">
               ...
               <f:TabStrip ID="TabStrip1" CssClass="f-tabstrip-theme-simple"  Height="700"    ShowBorder="true"
                    ...
                    <Tabs>
                                ...
                                <f:Form ID="Form2" ShowBorder="false" ShowHeader="false" AutoScroll="true" Title="施工合同会签评审单"
                                    ...
                                    <Items>
                                       ...
                                       <f:CheckBoxList ID="CBContractType" Label="合同类型" runat="server" ColumnNumber="3" ColumnWidth="50%">
                                        ...
                                        <f:TextArea ID="txtnode10" Height="150px" Required="true" Label="法律合规部" ShowRedStar="true" runat="server" Text="">
                                        </f:TextArea>
                                    </Items>
                                </f:Form>
                            ...
                            <Toolbars>
                                <f:Toolbar ID="Toolbar3" Position="Top" ToolbarAlign="Right" runat="server">
                                    <Items>
                                        ...
                                        <f:Button ID="btnAgree" Icon="SystemSave" runat="server" ToolTip="同意" Text="同意" ValidateForms="SimpleForm1" Enabled="false"
                                            OnClick="btnAgree_Click" ConfirmText="请确认是否同意！" Size="Medium">
                                        </f:Button>
                                        <f:Button ID="btnDisgree" Icon="SystemSave" runat="server" ToolTip="不同意" Text="不同意" ValidateForms="SimpleForm1" Enabled="false"
                        ...
                        <f:Tab ID="Tab3" Title="施工合同签订审批表" BodyPadding="5px" Layout="Fit" IconFont="Bookmark" runat="server">
                            <Items>
                                <f:Form ID="Form4" ShowBorder="false" ShowHeader="false" AutoScroll="true" Title="施工合同签订审批表"
                                    BodyPadding="10px" runat="server" RedStarPosition="BeforeText" LabelAlign="Right">
                                    <Items>
                                       ...
                                       <f:CheckBoxList ID="Tab3_CBContractType" Label="合同类型" runat="server" ColumnNumber="3" ColumnWidth="50%">
                                        ...
                                        <f:TextArea ID="txtnode11" Height="150px" Required="true" Label="施工管理部" ShowRedStar="true" runat="server" Text="">
                                        </f:TextArea>
                                        <f:TextArea ID="txtnode12" Height="150px" Required="true" Label="法律合规部" ShowRedStar="true" runat="server" Text="">
                                        </f:TextArea>
                                        <f:TextArea ID="txtnode13" Height="150px" Required="true" Label="项目经理" ShowRedStar="true" runat="server" Text="">
                                        </f:TextArea>
                                        <f:TextArea ID="txtnode14" Height="150px" Required="true" Label="分管副总经理" ShowRedStar="true" runat="server" Text="">
                                        </f:TextArea>
                                        <f:TextArea ID="txtnode15" Height="150px" Required="true" Label="总会计师" ShowRedStar="true" runat="server" Text="">
                                        </f:TextArea>
                                        <f:TextArea ID="txtnode16" Height="150px" Required="true" Label="总经理" ShowRedStar="true" runat="server" Text="">
                                        </f:TextArea>
                                        <f:TextArea ID="txtnode17" Height="150px" Required="true" Label="董事长" ShowRedStar="true" runat="server" Text="">
                                        </f:TextArea>
                                    </Items>
                                </f:Form>
        ...
        <f:Window ID="Window1" Title="查看" Hidden="true" EnableIFrame="true" EnableMaximize="true" EnableResize="true" IsModal="false" EnableDrag="true" EnableMinimize="true"
            Target="Parent"  runat="server"    
