<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AttachUrl20.aspx.cs" Inherits="FineUIPro.Web.PHTGL.ContractCompile.AttachUrl20" ValidateRequest="false" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Panel ID="Panel4" IsFluid="true" CssClass="blockpanel" BodyPadding="10" Layout="VBox" MaxHeight="550" BoxConfigChildMargin="0 0 5 0" AutoScroll="true"
            EnableCollapse="true" Title="附件20   其他" runat="server">
            <Items>
                <f:Form ID="Form2" ShowBorder="false" ShowHeader="false" Title="" AutoScroll="true"
                    ...
                    <Items>
                        <f:FormRow>
                            <Items>
                                <f:Label ID="Label1" runat="server" Text="附件20   其他" CssClass="widthBlod"></f:Label>
                            </Items>
                        </f:FormRow>
                        <f:FormRow>
                            <Items>
