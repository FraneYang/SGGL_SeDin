                ...
                <f:FormRow>
                    <Items>
                        <f:ContentPanel ID="ContentPanel1" runat="server" ShowHeader="false" ShowBorder="false">
                            ...
                            <f:TextBox runat="server" Label="" ID="txtContractId"
                                Width="300px" LabelAlign="right">
                            </f:TextBox>
                            <f:Label runat="server" ID="Label6" Text="）的施工工作,"></f:Label>
                            <br />
                               <f:TextBox runat="server" Label="工程合同工期从" ID="txtStartDate"
                                Width="300px" LabelAlign="right">
                            </f:TextBox>
                               <f:TextBox runat="server" Label="至" ID="txtEndDate"
                                Width="300px" LabelAlign="right">
                            </f:TextBox>
  
                            <br />
                            <f:Label ID="Label30" runat="server" Text="计划使用施工作业人员"></f:Label>
                            <f:TextBox ID="txtPersonSum" runat="server" AutoPostBack="true"></f:TextBox>
