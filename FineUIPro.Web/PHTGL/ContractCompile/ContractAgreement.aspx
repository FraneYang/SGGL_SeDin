<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ContractAgreement.aspx.cs" Inherits="FineUIPro.Web.PHTGL.ContractCompile.ContractAgreement" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Panel ID="Panel1" runat="server" Margin="5px" BodyPadding="5px" ShowBorder="false"
            ...
            <Items>
                <f:Grid ID="Grid1" ShowBorder="true" EnableAjax="false" ShowHeader="false" Title="合同协议书" EnableCollapse="true"
        ...
        <f:Window ID="Window1" Title="合同协议书" Hidden="true" EnableIFrame="true" EnableMaximize="true"
