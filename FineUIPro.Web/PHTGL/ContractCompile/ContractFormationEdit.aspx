                ...
                <f:TabStrip ID="TabStrip1" CssClass="f-tabstrip-theme-simple" Height="700" ShowBorder="true"
                    ...
                    <Tabs>
                            ...
                            <Items>
                                <f:Form ID="SimpleForm1" ShowBorder="false" ShowHeader="false" AutoScroll="false" Title="基本信息"
                                    ...
                                    <Rows>
                                        ...
                                        <f:FormRow>
                                            <Items>
                                                <f:TextArea ID="tab1_txtRemark" runat="server" Label="合同摘要" LabelAlign="Right" MaxLength="1000" LabelWidth="120px"></f:TextArea>
                                            </Items>
                                        </f:FormRow>
                                    </Rows>
                                    <Toolbars>
                        ...
                        <f:Tab ID="Tab2" Title="合同协议书" BodyPadding="5px" Layout="Fit" IconFont="Bookmark" runat="server">
                            <Toolbars>
                                <f:Toolbar ID="Toolbar3" Position="Top" ToolbarAlign="Right" runat="server">
                                    <Items>
                                        <f:Button ID="btnSave" runat="server" Icon="SystemSave" Text="保存" ToolTip="保存" OnClick="btnSave_Tab_2_Click"></f:Button>
                                    </Items>
                                </f:Toolbar>
                            </Toolbars>
                            <Items>
                                <f:Form ID="Form2" ShowBorder="false" ShowHeader="false" AutoScroll="true" Title="分包合同协议书"
                                    ...
                                    <Rows>
                                        ...
                                        <f:FormRow>
                                            <Items>
                                                <f:Label ID="Label3" runat="server" Text="1	分包工程概况" CssClass="widthBlod"></f:Label>
                                            </Items>
                                        </f:FormRow>
                                        <f:FormRow>
                                            <Items>
                                        ...
                                        <f:FormRow>
                                            <Items>
                                                <f:Label ID="Label4" runat="server" Text="2	工程承包范围及施工内容" CssClass="widthBlod"></f:Label>
                                            </Items>
                                        </f:FormRow>
                                        <f:FormRow>
                                            <Items>
                                        ...
                                        <f:FormRow>
                                            <Items>
                                                <f:Label ID="Label5" runat="server" Text="3	分包合同工期" CssClass="widthBlod"></f:Label>
                                            </Items>
                                        </f:FormRow>
                                        ...
                                        <f:FormRow>
                                            <Items>
                                                <f:Label ID="Label10" runat="server" Text="4	质量标准、HSE标准" CssClass="widthBlod"></f:Label>
                                            </Items>
                                        </f:FormRow>
                                        <f:FormRow>
                                            <Items>
                                        ...
                                        <f:FormRow>
                                            <Items>
                                                <f:Label ID="Label11" runat="server" Text="5  安全标准化和智慧化工地建设" CssClass="widthBlod"></f:Label>
                                            </Items>
                                        </f:FormRow>
                                        <f:FormRow>
                                            <Items>
                                        ...
                                        <f:FormRow>
                                            <Items>
                                                <f:Label ID="Label12" runat="server" Text="6	签约合同价格形式与合同价格" CssClass="widthBlod"></f:Label>
                                            </Items>
                                        </f:FormRow>
                                        <f:FormRow>
                                            <Items>
                                        ...
                                        <f:FormRow>
                                            <Items>
                                                <f:Label ID="Label18" runat="server" Text="7	合同文件构成及解释顺序" CssClass="widthBlod"></f:Label>
                                            </Items>
                                        </f:FormRow>
                                        <f:FormRow>
                                            <Items>
                                        ...
                                        <f:FormRow>
                                            <Items>
                                                <f:Label ID="Label19" runat="server" Text="8	承诺" CssClass="widthBlod"></f:Label>
                                            </Items>
                                        </f:FormRow>
                                        <f:FormRow>
                                            <Items>
                                        ...
                                        <f:FormRow>
                                            <Items>
                                                <f:Label ID="Label20" runat="server" Text="9	法律" CssClass="widthBlod"></f:Label>
                                            </Items>
                                        </f:FormRow>
                                        <f:FormRow>
                                            <Items>
                                        ...
                                        <f:FormRow>
                                            <Items>
                                                <f:Label ID="Label21" runat="server" Text="10	其他" CssClass="widthBlod"></f:Label>
                                            </Items>
                                        </f:FormRow>
                                        <f:FormRow>
                                            <Items>
                        ...
                        <f:Tab ID="Tab4" Title="专用条款" BodyPadding="5px" Layout="Fit" IconFont="Bookmark" runat="server">
                            <Items>
                                <f:Form ID="Form_Tab4" ShowBorder="false" ShowHeader="false" AutoScroll="true" Title="分包合同协议书"
                                    BodyPadding="10px" runat="server" RedStarPosition="BeforeText" LabelAlign="Right">
                                    <Rows>
                                        <f:FormRow>
                                            <Items>
                                        ...
                                        <f:FormRow>
                                            <Items>
                                                <f:Panel ID="Panel15" runat="server" ShowHeader="false" ShowBorder="false">
                                                    ...
                                                    <Items>
                                                        <f:ContentPanel ID="ContentPanel2" runat="server" ShowHeader="false" ShowBorder="false">
                                                            ...
                                                            <br />
                                                            <f:Label runat="server" ID="Label52" Text="1.1.1总包合同是指："></f:Label>
                                                            ...
                                                            <br />
                                                            <f:Label runat="server" ID="Label53" Text="1.1.2其他分包合同文件包括："></f:Label>
                                                            <f:TextBox runat="server" Label="" ID="OtherSubDocuments" AutoPostBack="true" OnTextChanged="TextBoxChanged"
                                                                Width="120px" LabelAlign="right">
                                                            </f:TextBox>
                                                            <br />
                                                            <f:Label runat="server" ID="Label54" Text="1.1.28作为施工场地组成部分的其他场所包括："></f:Label>
                                                            <f:TextBox runat="server" Label="" ID="OtherPlaces" AutoPostBack="true" OnTextChanged="TextBoxChanged"
                                                                Width="120px" LabelAlign="right">
                                                            </f:TextBox>
                                                            <br />
                                                            <f:Label runat="server" ID="Label55" Text="1.1.49分包合同适用的其他规范性文件："></f:Label>
                                                            ...
                                                            <br />
                                                            <f:Label runat="server" ID="Label57" Text="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;适用于分包工程的需要特别指出的标准和规范包括："></f:Label>
                                                            ...
                                                            <br />
                                                            <f:Label runat="server" ID="Label59" Text="1.4.1总承包商向施工分包商提供图纸的期限："></f:Label>
                                                            <f:TextBox runat="server" Label="" ID="DrawingPeriod" AutoPostBack="true" OnTextChanged="TextBoxChanged"
                                                                Width="120px" LabelAlign="right">
                                                            </f:TextBox>
                                                            <br />
                                                            <f:Label runat="server" ID="Label60" Text="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;总承包商向施工分包商提供图纸的数量："></f:Label>
                                                            <f:TextBox runat="server" Label="" ID="DrawingCount" AutoPostBack="true" OnTextChanged="TextBoxChanged"
                                                                Width="120px" LabelAlign="right">
                                                            </f:TextBox>
                                                            <br />
                                                            <f:Label runat="server" ID="Label61" Text=" &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;总承包商向施工分包商提供图纸的内容："></f:Label>
                                                            ...
                                                            <br />
                                                            <f:Label runat="server" ID="Label63" Text=" &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;总承包商委托施工分包商进行深化设计的范围及费用承担："></f:Label>
                                                            ...
                                                            <br />
                                                            <f:Label runat="server" ID="Label65" Text=" &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;施工分包商向总承包商提供施工文件的数量：一式肆份；（示例性描述）"></f:Label>
                                                            <f:TextBox runat="server" Label="" ID="ConstructionSubFileCount" AutoPostBack="true" OnTextChanged="TextBoxChanged"
                                                                Width="120px" LabelAlign="right">
                                                            </f:TextBox>
                                                            <br />
                                                            <f:Label runat="server" ID="Label66" Text=" &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;施工分包商向总承包商提供施工文件的形式:"></f:Label>
                                                            ...
                                                            <br />
                                                            <f:Label runat="server" ID="Label83" Text="3施工分包商"></f:Label>
                                                            <br />
                                                            <f:Label runat="server" ID="Label84" Text="3.1施工分包商的一般义务"></f:Label>
                                                            <br />
                                                            <f:Label runat="server" ID="Label85" Text="3.1.1由施工分包商办理的许可和批准手续包括："></f:Label>
                                                            ...
                                                            <br />
                                                            <f:Label runat="server" ID="Label95" Text="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 施工分包商组织机构配置和关键人员名单详见附件。"></f:Label>
                                                            <f:TextBox runat="server" Label="" ID="AttachmentName" AutoPostBack="true" OnTextChanged="TextBoxChanged"
                                                                Width="120px" LabelAlign="right">
                                                            </f:TextBox>
                                                            <br />
                                                            <f:Label runat="server" ID="Label96" Text="3.2.2施工分包商项目经理每月在施工现场时间不得少于"></f:Label>
                                                            ...
                                                            <br />
                                                            <f:Label runat="server" ID="Label106" Text="3.6.2经总承包商确认的联合体协议详见附件。"></f:Label>
                                                            <f:TextBox runat="server" Label="" ID="AssociationAgreementAttachUrl" AutoPostBack="true" OnTextChanged="TextBoxChanged"
                                                                Width="120px" LabelAlign="right">
                                                            </f:TextBox>
                                                            <br />
                                                            <f:Label runat="server" ID="Label107" Text="5分包工程质量"></f:Label>
                                                            <br />
                                                            ...
                                                            <br />
                                                            <f:Label runat="server" ID="Label109" Text="6HSE管理"></f:Label>
                                                            <br />
                                                            ...
                                                            <br />
                                                            <f:Label runat="server" ID="Label120" Text="7工期和进度"></f:Label>
                                                            <br />
                                                            <f:Label runat="server" ID="Label121" Text="7.1施工组织"></f:Label>
                                                            <br />
                                                            ...
                                                            <br />
                                                            <f:Label runat="server" ID="Label127" Text=" &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;不利物质条件的其他情形："></f:Label>
                                                            ...
                                                            <br />
                                                            <f:Label runat="server" ID="Label129" Text="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 异常恶劣的气候条件包括："></f:Label>
                                                            <f:TextBox runat="server" Label="" ID="TextBox96" AutoPostBack="true" OnTextChanged="TextBoxChanged"
                                                                Width="120px" LabelAlign="right">
                                                            </f:TextBox>
                                                            <br />
                                                            <f:Label runat="server" ID="Label130" Text="8材料与设备"></f:Label>
                                                            <br />
                                                            <f:Label runat="server" ID="Label131" Text="8.1总承包商和施工分包商的供应范围："></f:Label>
                                                            <f:TextBox runat="server" Label="" ID="MaterialEquipmentSupplyRange" AutoPostBack="true" OnTextChanged="TextBoxChanged"
                                                                Width="120px" LabelAlign="right">
                                                            </f:TextBox>
                                                            <br />
                                                            <f:Label runat="server" ID="Label132" Text="8.3总承包商供应的材料与工程设备"></f:Label>
                                                            <f:TextBox runat="server" Label="" ID="TextBox99" AutoPostBack="true" OnTextChanged="TextBoxChanged"
                                                                Width="120px" LabelAlign="right">
                                                            </f:TextBox>
                                                            <br />
                                                            <f:Label runat="server" ID="Label133" Text="8.3.2总承包商供应的材料设备，由施工分包商负责卸至指定地点的卸车费标准："></f:Label>
                                                            <f:TextBox runat="server" Label="" ID="UnloadingRateStandard" AutoPostBack="true" OnTextChanged="TextBoxChanged"
                                                                Width="120px" LabelAlign="right">
                                                            </f:TextBox>
                                                            <br />
                                                            <f:Label runat="server" ID="Label134" Text="8.3.3总承包商供应的其它材料设备从总承包商现场仓库出库到施工作业地点的二次搬运费标准："></f:Label>
                                                            ...
                                                            <br />
                                                            <f:Label runat="server" ID="Label138" Text="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 关于材料与工程设备替代的约定："></f:Label>
                                                            ...
                                                            <br />
                                                            <f:Label runat="server" ID="Label140" Text="8.8.1总承包商提供的施工设备和临时设施包括："></f:Label>
                                                            <f:TextBox runat="server" Label="" ID="Equipment" AutoPostBack="true" OnTextChanged="TextBoxChanged"
                                                                Width="120px" LabelAlign="right">
                                                            </f:TextBox>
                                                            <br />
                                                            <f:Label runat="server" ID="Label141" Text="10分包合同变更"></f:Label>
                                                            <br />
                                                            <f:Label runat="server" ID="Label142" Text="10.1分包合同变更的范围"></f:Label>
                                                            <br />
                                                            <f:Label runat="server" ID="Label143" Text=" &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;属于分包合同变更的其他情形："></f:Label>
                                                            ...
                                                            <br />
                                                            <f:Label runat="server" ID="Label146" Text=" &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;变更估价的其他原则："></f:Label>
                                                            ...
                                                            <br />
                                                            <f:Label runat="server" ID="Label148" Text=" &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;施工分包商提出的合理化建议降低了合同价格或者提高了工程经济效益的，奖励的方法和金额为："></f:Label>
                                                            ...
                                                            <br />
                                                            <f:Label runat="server" ID="Label150" Text="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 因变更引起工期变化的，确定增减工期天数的方法："></f:Label>
                                                            <f:TextBox runat="server" Label="" ID="IncreaseDecreasePeriod" AutoPostBack="true" OnTextChanged="TextBoxChanged"
                                                                Width="120px" LabelAlign="right">
                                                            </f:TextBox>
                                                            <br />
                                                            <f:Label runat="server" ID="Label151" Text="11合同价格"></f:Label>
                                                            <br />
                                                            <f:Label runat="server" ID="Label152" Text=" &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;（1）单价合同"></f:Label>
                                                            <br />
                                                            <f:Label runat="server" ID="Label153" Text=" &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;合同单价包含的风险范围："></f:Label>
                                                            ...
                                                            <br />
                                                            <f:Label runat="server" ID="Label158" Text=" &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;总价包含的风险范围："></f:Label>
                                                            ...
                                                            <br />
                                                            <f:Label runat="server" ID="Label178" Text="14.3.2进度付款申请单应包括的内容："></f:Label>
                                                            <f:TextBox runat="server" Label="" ID="ProgressPaymentContents" AutoPostBack="true" OnTextChanged="TextBoxChanged"
                                                                Width="120px" LabelAlign="right">
                                                            </f:TextBox>
                                                            <br />
                                                            <f:Label runat="server" ID="Label179" Text="14.3.3进度款审核与支付（此部分是填空，但需要固定化）"></f:Label>
                                                            ...
                                                            <f:Label runat="server" ID="Label180" Text="16试车"></f:Label>
                                                            <br />
                                                            <f:Label runat="server" ID="Label181" Text="16.1试车的组织和配合（此部分是填空，但需要固定化）"></f:Label>
                                                            <f:TextBox runat="server" Label="" ID="TextBox150" AutoPostBack="true" OnTextChanged="TextBoxChanged"
                                                                Width="120px" LabelAlign="right">
                                                            </f:TextBox>
                                                            <br />
                                                            <f:Label runat="server" ID="Label182" Text="（3）保运工作范围的约定："></f:Label>
                                                            ...
                                                            <br />
                                                            <f:Label runat="server" ID="Label185" Text="17竣工验收"></f:Label>
                                                            <br />
                                                            <f:Label runat="server" ID="Label186" Text="17.1竣工验收条件"></f:Label>
                                                            <br />
                                                            <f:Label runat="server" ID="Label187" Text=" &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;（4）申请竣工验收应具备的其他条件："></f:Label>
                                                            ...
                                                            <br />
                                                            <f:Label runat="server" ID="Label204" Text="20.2.1保修期的起算日："></f:Label>
                                                            <f:TextBox runat="server" Label="" ID="WarrantyPeriodDate" AutoPostBack="true" OnTextChanged="TextBoxChanged"
                                                                Width="120px" LabelAlign="right">
                                                            </f:TextBox>
                                                            <br />
                                                            <f:Label runat="server" ID="Label205" Text="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 保修期具体期限："></f:Label>
                                                            ...
                                                            <br />
                                                            <f:Label runat="server" ID="Label207" Text="20.3.1质量保证金的扣留金额和扣留方式："></f:Label>
                                                            <f:TextBox runat="server" Label="" ID="MarginDetainWay" AutoPostBack="true" OnTextChanged="TextBoxChanged"
                                                                Width="120px" LabelAlign="right">
                                                            </f:TextBox>
                                                            <br />
                                                            <f:Label runat="server" ID="Label208" Text="21违约"></f:Label>
                                                            <br />
                                                            <f:Label runat="server" ID="Label209" Text="21.1总承包商违约"></f:Label>
                                                            <br />
                                                            <f:Label runat="server" ID="Label210" Text="21.1.1总承包商违约时应支付的违约金或违约金的计算方法："></f:Label>
                                                            ...
                                                            <br />
                                                            <f:Label runat="server" ID="Label212" Text="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 因总承包商违约解除合同的，关于已完工程估价、清算和付款的约定："></f:Label>
                                                            ...
                                                            <br />
                                                            <f:Label runat="server" ID="Label216" Text=" &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;因施工分包商违约解除合同的，关于分包工程估价、清算和付款的约定："></f:Label>
                                                            <f:TextBox runat="server" Label="" ID="SubDefaultCancelContract" AutoPostBack="true" OnTextChanged="TextBoxChanged"
                                                                Width="120px" LabelAlign="right">
                                                            </f:TextBox>
                                                            <br />
                                                            <f:Label runat="server" ID="Label217" Text="22不可抗力"></f:Label>
                                                            <br />
                                                            <f:Label runat="server" ID="Label218" Text="22.1不可抗力的确认和通知"></f:Label>
                                                            <br />
                                                            <f:Label runat="server" ID="Label219" Text="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;不可抗力的其他情形："></f:Label>
                                                            ...
                                                            <br />
                                                            <f:Label runat="server" ID="Label221" Text="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;（6）不被认为不可抗力的其他情形："></f:Label>
                                                            <f:TextBox runat="server" Label="" ID="NotConsideredForceMajeure" AutoPostBack="true" OnTextChanged="TextBoxChanged"
                                                                Width="120px" LabelAlign="right">
                                                            </f:TextBox>
                                                            <br />
                                                            <f:Label runat="server" ID="Label222" Text="22.5因不可抗力解除合同"></f:Label>
                                                            ...
                                                            <br />
                                                            <f:Label runat="server" ID="Label224" Text="23保险"></f:Label>
                                                            <br />
                                                            ...
                                                            <br />
                                                            <f:Label runat="server" ID="Label227" Text="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;（2）施工分包商投保意外伤害保险的赔偿限额："></f:Label>
                                                            <f:TextBox runat="server" Label="" ID="LimitIndemnity" AutoPostBack="true" OnTextChanged="TextBoxChanged"
                                                                Width="120px" LabelAlign="right">
                                                            </f:TextBox>
                                                            <br />
                                                            <f:Label runat="server" ID="Label228" Text="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;（3）施工机具保险的保险金额："></f:Label>
                                                            ...
                                                            <br />
                                                            <f:Label runat="server" ID="Label230" Text="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;施工分包商提交保险凭证和保险单复印件的期限："></f:Label>
                                                            <f:TextBox runat="server" Label="" ID="CertificateInsurance" AutoPostBack="true" OnTextChanged="TextBoxChanged"
                                                                Width="120px" LabelAlign="right">
                                                            </f:TextBox>
                                                            <br />
                                                            <f:Label runat="server" ID="Label231" Text="25争议解决"></f:Label>
                                                            <br />
                                                            ...
                                                            <br />
                                                            <f:Label runat="server" ID="Label234" Text="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;（1）向"></f:Label>
                                                            ...
                                                            <br />
                                                            <f:Label runat="server" ID="Label236" Text="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;（2）向"></f:Label>
                            ...
                            <Toolbars>
                                <f:Toolbar ID="Toolbar4" Position="Top" ToolbarAlign="Right" runat="server">
                                    <Items>
                                        <f:Button ID="btnSave_Tab4" ToolTip="保存" Text="保存" Icon="SystemSave" runat="server"
