<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GeneralTermsConditions.aspx.cs" Inherits="FineUIPro.Web.PHTGL.ContractCompile.GeneralTermsConditions" %>
    ...
    <form id="form1" runat="server">
        ...
        <f:Form ID="SimpleForm1" ShowBorder="false" ShowHeader="false" AutoScroll="true" Title="分包合同协议书"
            ...
            <Rows>
                <f:FormRow>
                    <Items>
                        <f:Label ID="Label1" runat="server" Text="通用合同条款" CssClass="formtitle f-widget-header"></f:Label>
                    </Items>
                </f:FormRow>
                <f:FormRow>
                    <Items>
