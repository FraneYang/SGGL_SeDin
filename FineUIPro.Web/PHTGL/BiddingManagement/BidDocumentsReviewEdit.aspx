    ...
    <form id="form1" runat="server">
        ...
        <f:Form ID="SimpleForm1" ShowBorder="false" ShowHeader="false" AutoScroll="false" Title="审批信息"
            ...
            <Rows>
                <f:FormRow>
                    <Items>
                        <f:ContentPanel ID="ContentPanel1" Title="基本信息" ShowBorder="true"
                            ...
                            <Items>
                                <f:Form ID="Form2" ShowBorder="false" ShowHeader="false" AutoScroll="false" Title="基本信息"
                                    ...
                                    <Rows>
                                        ...
                                        <f:FormRow>
                                            <Items>
                                                <f:TextBox ID="txtEPCCode" runat="server" Label="总承包合同编号" LabelAlign="Right" Readonly="true" LabelWidth="140px"></f:TextBox>
                                        ...
                                        <f:FormRow>
                                            <Items>
                                                ...
                                                <f:DropDownList ID="txtBidType" runat="server" Label="招标方式" AutoSelectFirstItem="false" LabelAlign="Right" LabelWidth="140px" Required="true" ShowRedStar="true"></f:DropDownList>
                                        ...
                                        <f:FormRow>
                                            <Items>
                                                <f:TextArea ID="txtBidContent" runat="server" Label="招标内容" LabelAlign="Right"   LabelWidth="140px" AutoGrowHeight="true" ShowRedStar="true" Required="true" AutoGrowHeightMin="50"></f:TextArea>
                                              </Items>
                                        </f:FormRow>
                                        <f:FormRow>
                                            <Items>
                ...
                <f:FormRow>
                    <Items>
                        <f:ContentPanel ID="ContentPanel2" Title="审批流" ShowBorder="true"
                            BodyPadding="10px" EnableCollapse="true" ShowHeader="true" AutoScroll="true"
                            runat="server">
                            <Items>
                                <f:Form ID="Form3" ShowBorder="false" ShowHeader="false" AutoScroll="false" Title="基本信息"
                                    BodyPadding="10px" runat="server" RedStarPosition="BeforeText" LabelAlign="Right">
                                    <Rows>
                                        <f:FormRow>
                                            <Items>
                                                <f:DropDownList ID="DropConstructionManager" runat="server" AutoPostBack="true" EnableEdit="true" Label="施工经理" AutoSelectFirstItem="false" Required="true" ShowRedStar="true" LabelAlign="Right" LabelWidth="140px"></f:DropDownList>
                                            </Items>
                                        </f:FormRow>
                                        <f:FormRow>
                                            <Items>
                                                <f:DropDownList ID="DropControlManager" runat="server" AutoPostBack="true" EnableEdit="true" Label="控制经理"  AutoSelectFirstItem="false" Required="true" ShowRedStar="true" LabelAlign="Right" LabelWidth="140px"></f:DropDownList>
                                            </Items>
                                        </f:FormRow>
                                        <f:FormRow>
                                            <Items>
                                                <f:DropDownList ID="DropProjectManager" runat="server" AutoPostBack="true" EnableEdit="true" Label="项目经理"  AutoSelectFirstItem="false" Required="true" ShowRedStar="true" LabelAlign="Right" LabelWidth="140px"></f:DropDownList>
                                            </Items>
                                        </f:FormRow>
                                        <f:FormRow>
                                            <Items>
                                                <f:DropDownList ID="DropPreliminaryMan" runat="server" AutoPostBack="true" EnableEdit="true" Label="预审人员"  AutoSelectFirstItem="false"  Required="true" ShowRedStar="true" LabelAlign="Right" LabelWidth="140px"></f:DropDownList>
                                            </Items>
                                        </f:FormRow>
                                        <f:FormRow>
                                            <Items>
