<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SetSubFile.aspx.cs" Inherits="FineUIPro.Web.PHTGL.Filing.SetSubFile" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Panel ID="Panel1" runat="server" Margin="5px" BodyPadding="5px" ShowBorder="false"
            ...
            <Items>
                <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" Title="确定分包商审批表" EnableCollapse="true" EnableAjax="false"
