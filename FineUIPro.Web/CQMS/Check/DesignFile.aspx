<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DesignFile.aspx.cs" Inherits="FineUIPro.Web.CQMS.Check.DesignFile" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Panel ID="Panel1" runat="server" Margin="5px" BodyPadding="5px" ShowBorder="false"
            ...
            <Items>
                <f:Grid ID="Grid1" Title="设计变更记录" IsFluid="true" CssClass="blockpanel" ForceFit="true" ShowBorder="true" ShowHeader="false" runat="server" EnableCollapse="true" DataIDField="DesignId" SortField="DesignDate"  SortDirection="DESC"  BoxFlex="1"  AllowCellEditing="true"
                    DataKeyNames="DesignId" EnableColumnLines="true" ClicksToEdit="2" AllowSorting="true" AllowPaging="true" IsDatabasePaging="true" PageSize="10" EnableRowDoubleClickEvent="true" AllowFilters="false" EnableTextSelection="True"   OnRowCommand="Grid1_RowCommand" OnPageIndexChange="Grid1_PageIndexChange">
                    <Toolbars>
                        ...
                        <f:Toolbar ID="Toolbar3" Position="Top" runat="server" ToolbarAlign="Left">
                            <Items>
                                ...
                                <f:ToolbarFill runat="server"></f:ToolbarFill>
                                   <f:Button ID="btnExport" Icon="ArrowUp" runat="server"    ToolTip="导出">
                                            <Listeners>
