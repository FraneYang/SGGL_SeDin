<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SpotCheck.aspx.cs" Inherits="FineUIPro.Web.CQMS.Check.SpotCheck" %>
            ...
            <Items>
                ...
                <f:Grid ID="Grid1" ShowBorder="true" EnableAjax="false" ShowHeader="false" Title="工序验收记录" EnableCollapse="true"
                    ...
                    <Columns>
                        ...
                        <f:RenderField ColumnID="ProfessionalName" Width="80px" DataField="ProfessionalName"
                        ...
                        <f:RenderField ColumnID="CreateMan" Width="90px" DataField="CreateMan"
                        ...
                        <f:TemplateField ColumnID="State" Width="130px" HeaderText="审批状态" HeaderTextAlign="Center" TextAlign="Center"
                            EnableLock="true" Locked="False">
                            <ItemTemplate>
                                <asp:Label ID="Label2" runat="server" Text='<%# BLL.SpotCheckService.ConvertState(Eval("State"))%>'></asp:Label>
                            </ItemTemplate>
                        </f:TemplateField>
