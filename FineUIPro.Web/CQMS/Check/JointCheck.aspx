        ...
        <f:Panel ID="Panel1" runat="server" Margin="5px" BodyPadding="5px" ShowBorder="false"
            ...
            <Items>
                <f:Grid ID="GvJoinCheck" ShowBorder="true" ShowHeader="false" Title="质量共检" EnableCollapse="true"
                    ...
                    AllowPaging="true" IsDatabasePaging="true" PageSize="10" OnPageIndexChange="GvJoinCheck_PageIndexChange"
                    EnableRowDoubleClickEvent="true" OnRowDoubleClick="GvJoinCheck_RowDoubleClick" AllowFilters="true"
                    OnFilterChange="GvJoinCheck_FilterChange" EnableTextSelection="True">
                    <Toolbars>
                    ...
                    <Columns>
                        ...
                        <f:RenderField  Width="180px" ColumnID="JointCheckCode" DataField="JointCheckCode"
                        ...
                        <f:RenderField  ColumnID="CheckName" DataField="CheckName" Width="150px"
