<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CheckMonth.aspx.cs" Inherits="FineUIPro.Web.CQMS.Check.CheckMonth" %>
                    ...
                    <Toolbars>
                        <f:Toolbar ID="Toolbar1" Position="Top" runat="server" ToolbarAlign="Left">
                            <Items>
                                ...
                                <f:DatePicker runat="server" DateFormatString="yyyy-MM" Label="选择月份" ID="txtMonths" LabelAlign="right" LabelWidth="110px">
                                </f:DatePicker>
