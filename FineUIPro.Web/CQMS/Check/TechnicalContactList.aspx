<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TechnicalContactList.aspx.cs" Inherits="FineUIPro.Web.CQMS.Check.TechnicalContactList" %>
    ...
    <form id="form1" runat="server">
        ...
        <f:Panel ID="Panel1" runat="server" Margin="5px" BodyPadding="5px" ShowBorder="false"
            ...
            <Items>
                ...
                <f:Grid ID="Grid1" ShowBorder="true" EnableAjax="false" ShowHeader="false" Title="工程联络单" EnableCollapse="true"
                    ...
                    ClicksToEdit="2" DataIDField="TechnicalContactListId" OnRowDoubleClick="Grid1_RowDoubleClick" AllowSorting="true" SortField="Code"
                    ...
                    <Columns>
                        ...
                        <f:TemplateField ColumnID="State" Width="60px" HeaderText="审批状态" HeaderTextAlign="Center" TextAlign="Center"
                            EnableLock="true" Locked="False">
                            <ItemTemplate>
                                <asp:Label ID="Label2" runat="server" Text='<%# BLL.TechnicalContactListService.ConvertState(Eval("State"))%>'></asp:Label>
                            </ItemTemplate>
                        </f:TemplateField>
                        <f:TemplateField ColumnID="TechnicalContactListId" Width="80px" HeaderText="办理人" HeaderTextAlign="Center" TextAlign="Center"
                            EnableLock="true" Locked="False">
                            <ItemTemplate>
                                <asp:Label ID="Label1" runat="server" Text='<%# BLL.TechnicalContactListService.ConvertMan(Eval("TechnicalContactListId")) %>'></asp:Label>
                            </ItemTemplate>
                        </f:TemplateField>
        ...
        <f:Menu ID="Menu1" runat="server">
            <Items>
                ...
                <f:MenuButton ID="btnMenuDel" EnablePostBack="true" OnClick="btnMenuDel_Click" runat="server" Hidden="true" Icon="Delete" Text="删除" ConfirmText="确定删除当前数据？">
                </f:MenuButton>
            </Items>
        </f:Menu>
    </form>
