<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="uploader.aspx.cs" Inherits="FineUIPro.Web.AttachFile.uploader" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Grid ID="Grid1" runat="server" ShowHeader="false" ShowBorder="true" Title="文件上传"
            Width="650px" Height="360px" EnableColumnLines="true" ForceFit="true"
            EnableCollapse="false" EnableCheckBoxSelect="false" EmptyText="尚未上传文件"
            DataIDField="id" OnRowCommand="Grid1_RowCommand">
            <Toolbars>
                <f:Toolbar runat="server" ID="toolBar1" ToolbarAlign="left">
                    <Items>
                        <f:Label ID="fname" runat="server"></f:Label>
                    </Items>
                </f:Toolbar>
            ...
            <Columns>
                <f:LinkButtonField ColumnID="FileName" DataTextField="name" DataToolTipField="name" HeaderText="文件名"
                     CommandName="Attach" EnableAjax="false" />
