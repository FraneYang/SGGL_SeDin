<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SelectPipeline.aspx.cs" Inherits="FineUIPro.Web.HJGL.TestPackage.SelectPipeline" %>
                ...
                <f:Panel runat="server" ID="panelCenterRegion" RegionPosition="Center" ShowBorder="true"
                    ...
                    <Items>
                        <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" Title="试压包明细" EnableCollapse="true" Collapsed="false"
                            ...
                            OnPageIndexChange="Grid1_PageIndexChange" IsFluid="true" EnableCheckBoxSelect="true" ForceFit="true">
                            <Columns>
