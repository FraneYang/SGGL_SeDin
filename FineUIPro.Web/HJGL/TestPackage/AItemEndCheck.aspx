<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AItemEndCheck.aspx.cs" Inherits="FineUIPro.Web.HJGL.TestPackage.AItemEndCheck" %>
<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>试压前尾项A检查</title>
</head>
<body>
    ...
    <f:Panel ID="Panel1" runat="server" ShowBorder="false" ShowHeader="false" Layout="Region">
        <Items>
            ...
            <f:Panel runat="server" ID="panelCenterRegion" RegionPosition="Center" ShowBorder="true"
                Layout="VBox" ShowHeader="false" BodyPadding="5px" IconFont="PlusCircle" Title="试压前尾项A检查"
                TitleToolTip="试压前尾项A检查" AutoScroll="true">                                     
                <Items>
                    <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="true" Title="试压前尾项A检查录入(双击编辑)"  EnableCollapse="false" runat="server"
                        BoxFlex="1" DataKeyNames="AItemCheckId" AllowCellEditing="true" EnableColumnLines="true"
                        ClicksToEdit="2" DataIDField="AItemCheckId" AllowSorting="true" SortField="CheckDate" OnPreDataBound="Grid1_PreDataBound"
                        ...
                        <Columns>
                             <f:RenderField Width="120px" ColumnID="Remark" DataField="Remark" 
                                HeaderTextAlign="Center" HeaderText="A项检查内容" TextAlign="Left" ExpandUnusedSpace="true">
                                <Editor>
