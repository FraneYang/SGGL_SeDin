...
namespace FineUIPro.Web.HJGL.BaseInfo
{
    public partial class Material : PageBase
    {
        ...
        private string judgementDelete(string id)
        {
            ...
            //if (new Model.SGGLDB(Funs.ConnString).Pipeline_Pipeline.FirstOrDefault(x => x.MainMaterialId == id) != null || new Model.SGGLDB(Funs.ConnString).Pipeline_WeldJoint.FirstOrDefault(x => x.Material1Id == id) != null)
            //{
