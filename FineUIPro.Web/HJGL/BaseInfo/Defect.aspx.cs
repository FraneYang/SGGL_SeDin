...
namespace FineUIPro.Web.HJGL.BaseInfo
{
    public partial class Defect : PageBase
    {
        ...
        {
            if (CommonService.GetAllButtonPowerList(this.CurrUser.LoginProjectId, this.CurrUser.UserId, Const.HJGL_DefectMenuId, Const.BtnAdd))
            {
        ...
        private void EditData()
        {
            ...
            if (CommonService.GetAllButtonPowerList(this.CurrUser.LoginProjectId, this.CurrUser.UserId, Const.HJGL_DefectMenuId, Const.BtnModify))
            {
                    ...
                    foreach (int rowIndex in Grid1.SelectedRowIndexArray)
                    {
                        ...
                        if (getDefect != null)
                        {
                            ...
                            if (string.IsNullOrEmpty(cont))
                            {
                                ...
                                //BLL.Sys_LogService.AddLog(Const.System_6, this.CurrUser.LoginProjectId, this.CurrUser.UserId, Const.HJGL_DefectMenuId, Const.BtnDelete, rowID);
                            }
                            else
                            {
                                strShowNotify += "缺陷性质" + ":" + getDefect.DefectName + cont;
                            }
                        }
                    }
        ...
        {
            return BLL.CommonService.GetAllButtonPowerList(this.CurrUser.LoginProjectId, this.CurrUser.UserId, BLL.Const.HJGL_DefectMenuId, button);
        }
        #endregion
    }
}