<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TestMedium.aspx.cs" Inherits="FineUIPro.Web.HJGL.BaseInfo.TestMedium" %>
                    ...
                    <f:Toolbar ID="Toolbar2" Position="Top" runat="server" ToolbarAlign="Left">
                        <Items>
                            ...
                            <f:TextBox ID="txtMediumAbbreviation" runat="server" Label="介质相态"
                                EmptyText="输入查询条件" Width="300px" LabelWidth="160px" LabelAlign="Right">
                            </f:TextBox>
