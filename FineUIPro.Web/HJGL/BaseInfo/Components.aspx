<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Components.aspx.cs" Inherits="FineUIPro.Web.HJGL.BaseInfo.Components" %>
...
<body>
    ...
    <f:Panel ID="Panel1" runat="server" Margin="5px" BodyPadding="5px" ShowBorder="false"
        ...
        <Items>
            <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" Title="安装组件" EnableCollapse="true"
                runat="server" BoxFlex="1" EnableColumnLines="true" DataKeyNames="ComponentsId"
                AllowCellEditing="true" ClicksToEdit="2" DataIDField="ComponentsId" AllowSorting="true"
                SortField="ComponentsCode" SortDirection="DESC" OnSort="Grid1_Sort" AllowPaging="true"
                IsDatabasePaging="true" PageSize="15" OnPageIndexChange="Grid1_PageIndexChange"
                EnableRowDoubleClickEvent="true" OnRowDoubleClick="Grid1_RowDoubleClick" EnableTextSelection="True">
                <Toolbars>
                    <f:Toolbar ID="Toolbar2" Position="Top" runat="server" ToolbarAlign="Left">
                        <Items>
                            <f:TextBox ID="txtComponentsCode" runat="server" Label="组件代号" EmptyText="输入查询条件"
                                Width="300px" LabelWidth="140px" LabelAlign="Right">
                            </f:TextBox>  
                            <f:TextBox ID="txtComponentsName" runat="server" Label="组件名称" EmptyText="输入查询条件"
                                Width="300px" LabelWidth="140px" LabelAlign="Right">
                            </f:TextBox>  
