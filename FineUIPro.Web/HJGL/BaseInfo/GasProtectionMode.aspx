<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GasProtectionMode.aspx.cs" Inherits="FineUIPro.Web.HJGL.BaseInfo.GasProtectionMode" %>
...
<body>
    ...
    <f:Panel ID="Panel1" runat="server" Margin="5px" BodyPadding="5px" ShowBorder="false"
        ...
        <Items>
            <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" Title="气体保护方式" ForceFit="true"
                EnableCollapse="true" runat="server" BoxFlex="1" EnableColumnLines="true" DataKeyNames="GasProtectionModeId"
                AllowCellEditing="true" ClicksToEdit="2" DataIDField="GasProtectionModeId" AllowSorting="true"
                SortField="GasProtectionModeName" SortDirection="ASC" OnSort="Grid1_Sort" AllowPaging="true"
                IsDatabasePaging="true" PageSize="15" OnPageIndexChange="Grid1_PageIndexChange"
                EnableRowDoubleClickEvent="true" OnRowDoubleClick="Grid1_RowDoubleClick" EnableTextSelection="True">
                <Toolbars>
                    <f:Toolbar ID="Toolbar2" Position="Top" runat="server" ToolbarAlign="Left">
                        <Items>
                            <f:TextBox ID="txtGasProtectionModeName" runat="server" Label="气体保护方式名称"
                ...
                <Columns>
                    <f:RenderField Width="320px" ColumnID="GasProtectionModeName" DataField="GasProtectionModeName" FieldType="String"
                        HeaderText="气体保护方式名称" HeaderTextAlign="Center"
                        TextAlign="Left" SortField="GasProtectionModeName">
                    </f:RenderField>
