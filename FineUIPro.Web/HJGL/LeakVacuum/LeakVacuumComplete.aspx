<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LeakVacuumComplete.aspx.cs" Inherits="FineUIPro.Web.HJGL.LeakVacuum.LeakVacuumComplete" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>泄露性/真空试验</title>
    <style type="text/css">
        .Cyan span {
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Panel ID="Panel1" runat="server" ShowBorder="false" ShowHeader="false" Layout="Region">
            <Items>
                <f:Panel runat="server" ID="panelLeftRegion" RegionPosition="Left" RegionSplit="true"
                    EnableCollapse="true" Width="230px" Title="泄露性/真空试验" ShowBorder="true" Layout="VBox"
                    ...
                    <Items>
                        <f:Tree ID="tvControlItem" ShowHeader="false" Title="泄露性/真空试验节点树" OnNodeCommand="tvControlItem_NodeCommand"
                ...
                <f:Panel runat="server" ID="panelCenterRegion" RegionPosition="Center" ShowBorder="true"
                    Layout="VBox" ShowHeader="false" BodyPadding="5px" IconFont="PlusCircle" Title="泄露性/真空试验"
                    TitleToolTip="泄露性/真空试验" AutoScroll="true">
                    <Toolbars>
                        <f:Toolbar ID="Toolbar2" Position="Top" runat="server" ToolbarAlign="Right">
                            <Items>
                                <f:HiddenField runat="server" ID="hdLeakVacuumId"></f:HiddenField>
                                <f:ToolbarFill ID="ToolbarFill1" runat="server"></f:ToolbarFill>
                                <f:Button ID="btnAudit" Text="泄露性/真空试验完成" ToolTip="施工单位录入试压负责人、完工日期及完工描述" Icon="TableKey" runat="server" OnClick="btnAudit_Click" Hidden="true" ValidateForms="SimpleForm1">
                                </f:Button>
                                <f:Button ID="btnCancelAudit" Text="取消审核" ToolTip="取消审核泄露性/真空试验" Icon="TableGo" runat="server" OnClick="btnCancelAudit_Click"
                                    ConfirmText="确认取消审核此泄露性/真空试验?" ConfirmTarget="Top" Hidden="true">
                                </f:Button>
                    ...
                    <Items>
                        <f:Form ID="SimpleForm1" ShowBorder="true" ShowHeader="true" Title="泄露性/真空试验" AutoScroll="true" EnableCollapse="true" Collapsed="false"
                            ...
                            <Rows>
                                ...
                                <f:FormRow>
                                    <Items>
                                        <f:Label ID="txtAuditMan" Label="审核人" runat="server" LabelWidth="130px">
                                        </f:Label>
                                        <f:Label ID="txtAuditDate" Label="审核日期" runat="server" LabelWidth="130px">
                                        </f:Label>
                                        <f:DropDownList ID="drpFinisher" Label="完工人" runat="server" ShowRedStar="true" Required="true" EnableEdit="true" LabelWidth="130px">
                                        </f:DropDownList>
                                        <f:DatePicker ID="txtFinishDate" Label="完工日期" runat="server" DateFormatString="yyyy-MM-dd"
                                            ShowRedStar="true" Required="true" LabelWidth="130px">
                                        </f:DatePicker>
                                        <f:TextBox runat="server" ID="txtFinishDef" Label="完工描述" Width="320px" LabelWidth="130px"></f:TextBox>
                                    </Items>
                                </f:FormRow>
                            </Rows>
                        </f:Form>
                    ...
                    <Items>
                        <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="true" Title="泄露性/真空试验明细" EnableCollapse="true" Collapsed="false"
        ...
        <f:Window ID="Window1" Title="泄露性/真空试验维护" Hidden="true" EnableIFrame="true" EnableMaximize="true"
            Target="Top" EnableResize="true" runat="server" OnClose="Window1_Close" IsModal="true"
            Width="1000px" Height="660px">
        </f:Window>
        <f:Window ID="Window2" Title="泄露性/真空试验打印" Hidden="true" EnableIFrame="true"
