                    ...
                    <Items>
                        <f:Form runat="server" ShowHeader="false" ShowBorder="false">
                            <Rows>
                                <f:FormRow>
                                    <Items>
                                        <f:TextBox ID="txtWeldJointCode" Label="焊口号" EmptyText="前缀字符(可选择输入)" LabelAlign="Right"
                                            runat="server" FocusOnPageLoad="true" LabelWidth="100px">
                                        </f:TextBox>
                                        <f:NumberBox ID="txtWeldJointCode1" Label="起" runat="server" LabelAlign="Right"
                                            NoDecimal="true" NoNegative="true" ShowRedStar="true" Required="true" LabelWidth="100px">
                                        </f:NumberBox>
                                        <f:NumberBox ID="txtWeldJointCode2" Label="止" runat="server" LabelAlign="Right"
