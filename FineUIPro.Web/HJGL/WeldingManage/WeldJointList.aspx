                ...
                <Items>
                    <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" Title="焊口信息"
                        ...
                        <Columns>
                            ...
                            <f:RenderField HeaderText="是否焊接" ColumnID="IsWelding"
                                DataField="IsWelding" SortField="IsWelding" FieldType="String" HeaderTextAlign="Center"
                            ...
                            <f:RenderField HeaderText="焊接区域" ColumnID="JointArea"
                                DataField="JointArea" SortField="JointArea" FieldType="String" HeaderTextAlign="Center"
                                TextAlign="Left" Width="90px">
                            </f:RenderField>

                            <f:RenderField HeaderText="材质1" ColumnID="Material1Code"
                                DataField="Material1Code" SortField="Material1Code" FieldType="String" HeaderTextAlign="Center"
                                TextAlign="Left" Width="90px">
                            </f:RenderField>
                            ...
                            <f:RenderField HeaderText="炉批1号" ColumnID="HeartNo1"
                                DataField="HeartNo1" SortField="HeartNo1" FieldType="String" HeaderTextAlign="Center"
                                TextAlign="Left" Width="90px">
                            </f:RenderField>
                            <f:RenderField HeaderText="炉批2号" ColumnID="HeartNo2"
                                DataField="HeartNo2" SortField="HeartNo2" FieldType="String" HeaderTextAlign="Center"
                                TextAlign="Left" Width="90px">
                            </f:RenderField>
                            ...
                            <f:RenderField HeaderText="日报编号" ColumnID="WeldingDailyCode"
                                DataField="WeldingDailyCode" SortField="WeldingDailyCode" FieldType="String"
                                HeaderTextAlign="Center" TextAlign="Left" Width="90px">
                            </f:RenderField>
