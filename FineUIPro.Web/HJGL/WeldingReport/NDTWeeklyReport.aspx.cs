...
{
    public partial class NDTWeeklyReport : PageBase
    {
        ...
        private void BindGrid()
        {
            ...
            DataTable tb = SQLHelper.GetDataTableRunProc("sp_HJGL_WeldingWeekReport", parameter);
        ...
        protected void btnOut_Click(object sender, EventArgs e)
        {
            ...
            Response.AddHeader("content-disposition", "attachment; filename=" + System.Web.HttpUtility.UrlEncode("无损检测周统计报表" + filename, System.Text.Encoding.UTF8) + ".xls");
