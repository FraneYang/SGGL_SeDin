<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WelderAvgPerformance.aspx.cs" Inherits="FineUIPro.Web.HJGL.WeldingReport.WelderAvgPerformance" %>
...
<body>
    ...
    <f:Panel ID="Panel1" runat="server" Margin="5px" BodyPadding="5px" ShowBorder="false"
        ...
        <Items>
            <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" Title="焊工平均业绩"
                EnableCollapse="true" runat="server" BoxFlex="1" EnableColumnLines="true" DataKeyNames="UnitCode"
                AllowCellEditing="true" ClicksToEdit="2" DataIDField="UnitCode" AllowSorting="true"
                ...
                <Columns>
                    ...
                    <f:RenderField HeaderText="单位名称" ColumnID="UnitName"
