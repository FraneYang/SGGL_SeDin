<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CheckerItem.aspx.cs" Inherits="FineUIPro.Web.HJGL.PersonManage.CheckerItem" %>
            ...
            <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" EnableCollapse="true" runat="server"
                ...
                <Toolbars>
                    <f:Toolbar ID="Toolbar2" Position="Top" runat="server" ToolbarAlign="Right">
                        <Items>
                            <f:Label ID="lblWelderName" runat="server" Label="无损检测工姓名"
