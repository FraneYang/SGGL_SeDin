<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RepairTrust.aspx.cs" Inherits="FineUIPro.Web.HJGL.RepairAndExpand.RepairTrust" %>
                    ...
                    <Toolbars>
                        <f:Toolbar ID="Toolbar3" Position="Top" runat="server" ToolbarAlign="Right">
                            <Items>
                                ...
                                <f:Button ID="btnPointAudit" Text="生成委托单" ToolTip="监理点口审核并生成委托单" Icon="ArrowNsew" runat="server" Hidden="true"
