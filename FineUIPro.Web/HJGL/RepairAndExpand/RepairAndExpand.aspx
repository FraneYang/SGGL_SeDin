                ...
                <f:Panel runat="server" ID="panelCenterRegion" RegionPosition="Center" ShowBorder="true"
                    ...
                    <Items>
                        <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" Title="点口管理" EnableCollapse="true"
                            runat="server" BoxFlex="1" DataKeyNames="PointBatchItemId,UnitId" AllowCellEditing="true"
                            ...
                            <Columns>
                                ...
                                <%--<f:TemplateField ColumnID="BackingWelderId" Width="130px" HeaderText="返修打底焊工" HeaderTextAlign="Center" TextAlign="Center"
                                    ...
                                    <ItemTemplate>
                                        ...
                                        <asp:HiddenField ID="hdBackingWelderId" runat="server" Value='<%# Bind("BackingWelderId") %>' />
                                    </ItemTemplate>
                                </f:TemplateField>
                                 <f:TemplateField ColumnID="CoverWelderId" Width="130px" HeaderText="返修盖面焊工" HeaderTextAlign="Center" TextAlign="Center"
                                    EnableLock="true" Locked="False">
                                    <ItemTemplate>
                                        <asp:DropDownList ID="drpCoverWelderId" runat="server" Height="22" Width="90%">
                                        </asp:DropDownList>
