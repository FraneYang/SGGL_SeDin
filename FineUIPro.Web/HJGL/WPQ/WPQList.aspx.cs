    ...
    public partial class WPQList : PageBase
    {
        ...
        private void BindGrid()
        {
            string strSql = @"SELECT wpq.WPQId,u.UnitName,wpq.WPQCode,wpq.CompileDate,wpq.Specifications,
                                     ...
                                     wpq.WeldingPosition,wpq.WeldingMethodId,wpq.MinImpactDia,wpq.MaxImpactDia,
                                     wpq.MinImpactThickness,wpq.MaxImpactThickness,wpq.NoMinImpactThickness,
                                     wpq.NoMaxImpactThickness,(CASE wpq.IsHotProess WHEN 1 THEN '是' ELSE '否' END) AS IsHotProess, 
