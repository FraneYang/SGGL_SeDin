<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PC_ItemEndCheck.aspx.cs" Inherits="FineUIPro.Web.HJGL.PurgingCleaning.PC_ItemEndCheck" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>吹扫/清洗尾项检查</title>
</head>
<body>
        ...
        <f:Panel ID="Panel1" runat="server" ShowBorder="false" ShowHeader="false" Layout="Region">
            <Items>
                <f:Panel runat="server" ID="panelLeftRegion" RegionPosition="Left" RegionSplit="true"
                    EnableCollapse="true" Width="290px" Title="吹扫/清洗尾项检查" ShowBorder="true" Layout="VBox"
                ...
                <f:Panel runat="server" ID="panelCenterRegion" RegionPosition="Center" ShowBorder="true"
                    Layout="VBox" ShowHeader="false" BodyPadding="5px" IconFont="PlusCircle" Title="吹扫/清洗尾项检查"
                    TitleToolTip="吹扫/清洗尾项检查" AutoScroll="true">
                    <Items>
                        <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="true" Title="吹扫/清洗尾项检查录入(双击编辑)" EnableCollapse="false" runat="server"
                            BoxFlex="1" DataKeyNames="PCItemEndCheckId" AllowCellEditing="true" EnableColumnLines="true"
                            ClicksToEdit="2" DataIDField="PCItemEndCheckId" AllowSorting="true" SortField="CheckDate" OnPreDataBound="Grid1_PreDataBound"
