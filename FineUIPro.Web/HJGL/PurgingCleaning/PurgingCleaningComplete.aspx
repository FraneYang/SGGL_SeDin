<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PurgingCleaningComplete.aspx.cs" Inherits="FineUIPro.Web.HJGL.PurgingCleaning.PurgingCleaningComplete" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Panel ID="Panel1" runat="server" ShowBorder="false" ShowHeader="false" Layout="Region">
            <Items>
                <f:Panel runat="server" ID="panelLeftRegion" RegionPosition="Left" RegionSplit="true"
                    EnableCollapse="true" Width="230px" Title="吹扫/清洗试验" ShowBorder="true" Layout="VBox"
                    ...
                    <Items>
                        <f:Tree ID="tvControlItem" ShowHeader="false" Title="吹扫/清洗试验节点树" OnNodeCommand="tvControlItem_NodeCommand"
                ...
                <f:Panel runat="server" ID="panelCenterRegion" RegionPosition="Center" ShowBorder="true"
                    Layout="VBox" ShowHeader="false" BodyPadding="5px" IconFont="PlusCircle" Title="吹扫/清洗试验"
                    TitleToolTip="吹扫/清洗试验" AutoScroll="true">
                    <Toolbars>
                        <f:Toolbar ID="Toolbar2" Position="Top" runat="server" ToolbarAlign="Right">
                            <Items>
                                <f:HiddenField runat="server" ID="hdPurgingCleaningId"></f:HiddenField>
                                <f:ToolbarFill ID="ToolbarFill1" runat="server"></f:ToolbarFill>
                                <f:Button ID="btnAudit" Text="吹扫/清洗试验完成" ToolTip="施工单位录入试压负责人、完工日期及完工描述" Icon="TableKey" runat="server" OnClick="btnAudit_Click" Hidden="true" ValidateForms="SimpleForm1">
                                </f:Button>
                                <f:Button ID="btnCancelAudit" Text="取消审核" ToolTip="取消审核吹扫/清洗试验" Icon="TableGo" runat="server" OnClick="btnCancelAudit_Click"
                                    ConfirmText="确认取消审核此吹扫/清洗试验?" ConfirmTarget="Top" Hidden="true">
                                </f:Button>
                    ...
                    <Items>
                        <f:Form ID="SimpleForm1" ShowBorder="true" ShowHeader="true" Title="吹扫/清洗试验" AutoScroll="true" EnableCollapse="true" Collapsed="false"
                    ...
                    <Items>
                        <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="true" Title="吹扫/清洗试验包明细" EnableCollapse="true" Collapsed="false"
        ...
        <f:Window ID="Window1" Title="吹扫/清洗试验维护" Hidden="true" EnableIFrame="true" EnableMaximize="true"
            Target="Top" EnableResize="true" runat="server" OnClose="Window1_Close" IsModal="true"
            Width="1000px" Height="660px">
        </f:Window>
        <f:Window ID="Window2" Title="吹扫/清洗试验打印" Hidden="true" EnableIFrame="true"
