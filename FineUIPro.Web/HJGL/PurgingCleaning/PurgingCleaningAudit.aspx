<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PurgingCleaningAudit.aspx.cs" Inherits="FineUIPro.Web.HJGL.PurgingCleaning.PurgingCleaningAudit" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Panel ID="Panel1" runat="server" ShowBorder="false" ShowHeader="false" Layout="Region">
            <Items>
                <f:Panel runat="server" ID="panelLeftRegion" RegionPosition="Left" RegionSplit="true"
                    EnableCollapse="true" Width="230px" Title="吹扫/清洗试验包" ShowBorder="true" Layout="VBox"
                    ...
                    <Items>
                        <f:Tree ID="tvControlItem" ShowHeader="false" Title="吹扫/清洗试验包节点树" OnNodeCommand="tvControlItem_NodeCommand"
                ...
                <f:Panel runat="server" ID="panelCenterRegion" RegionPosition="Center" ShowBorder="true"
                    Layout="VBox" ShowHeader="false" BodyPadding="5px" IconFont="PlusCircle" Title="吹扫/清洗试验包"
                    TitleToolTip="吹扫/清洗试验包" AutoScroll="true">
                    <Toolbars>
                        <f:Toolbar ID="Toolbar2" Position="Top" runat="server" ToolbarAlign="Right">
                            <Items>
                                ...
                                <f:Button ID="btnAudit" Text="审核" ToolTip="审核检测单" AjaxLoadingType="Mask" ShowAjaxLoadingMaskText="true"
                                    AjaxLoadingMaskText="吹扫/清洗试验包审核中，请稍候"
                                    Icon="TableKey" runat="server" OnClick="btnAudit_Click" Hidden="true" ValidateForms="SimpleForm1">
                                </f:Button>
                                <f:Button ID="btnCancelAudit" Text="取消审核" ToolTip="取消审核吹扫/清洗试验包" Icon="TableGo" runat="server" OnClick="btnCancelAudit_Click"
                                    ConfirmText="确认取消审核此吹扫/清洗试验包?" ConfirmTarget="Top" Hidden="true">
                                </f:Button>
                    ...
                    <Items>
                        <f:Form ID="SimpleForm1" ShowBorder="true" ShowHeader="true" Title="吹扫/清洗试验包" AutoScroll="true" EnableCollapse="true" Collapsed="false"
        ...
        <f:Window ID="Window1" Title="吹扫/清洗试验包维护" Hidden="true" EnableIFrame="true" EnableMaximize="true"
            Target="Top" EnableResize="false" runat="server" OnClose="Window1_Close" IsModal="true"
            Width="1000px" Height="660px">
        </f:Window>
        <f:Window ID="Window2" Title="吹扫/清洗试验包打印" Hidden="true" EnableIFrame="true"
