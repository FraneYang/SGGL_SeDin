<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IssuedNotice.aspx.cs" Inherits="FineUIPro.Web.Notice.IssuedNotice" %>
...
<body>
        ...
        <Items>
          <f:Grid ID="SGrid" ShowBorder="true" ShowHeader="false" Title="发出通知" EnableCollapse="true" runat="server" BoxFlex="1" 
              ...
              OnPageIndexChange="SGrid_PageIndexChange" EnableRowDoubleClickEvent="true" OnRowDoubleClick="SGrid_RowDoubleClick" >
                    ...
                    <Columns>                                    
                        <f:RenderField Width="100px" ColumnID="NoticeCode" DataField="NoticeCode" SortField="NoticeCode"
    ...
    <f:Menu ID="Menu1" runat="server">
        <f:MenuButton ID="btnMenuEdit" OnClick="btnMenuEdit_Click" Icon="Find" EnablePostBack="true"
