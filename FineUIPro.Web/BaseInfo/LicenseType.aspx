...
<body>
    ...
    <f:Panel ID="Panel1" runat="server" Margin="5px" BodyPadding="5px" Title="许可证类型" ShowHeader="false"
        Layout="HBox">
        <Items>
            <f:Grid ID="Grid1" Title="许可证类型" ShowHeader="false" EnableCollapse="false" PageSize="10"   EnableColumnLines="true"  
                ...
                <Columns>                    
                    <f:RenderField Width="100px" ColumnID="LicenseTypeCode" DataField="LicenseTypeCode"
                        FieldType="String" HeaderText="编号" HeaderTextAlign="Center" TextAlign="Left">
                    </f:RenderField>
                    <f:RenderField Width="300px" ColumnID="LicenseTypeName" DataField="LicenseTypeName"
                        FieldType="String" HeaderText="类型名称" HeaderTextAlign="Center" TextAlign="Left">
                    </f:RenderField>
                    <f:RenderField  ColumnID="Remark" DataField="Remark" FieldType="String" Width="350px"
