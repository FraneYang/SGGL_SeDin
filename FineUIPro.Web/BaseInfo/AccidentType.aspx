            ...
            <f:Grid ID="Grid1" Title="事故类型" ShowHeader="false" EnableCollapse="true" PageSize="10"  EnableColumnLines="true"
                ...
                <Columns>
                   <f:RowNumberField EnablePagingNumber="true" HeaderText="序号" Width="50px" HeaderTextAlign="Center" TextAlign="Center"/>
                    <f:RenderField Width="90px" ColumnID="AccidentTypeCode" DataField="AccidentTypeCode" FieldType="String"
                        HeaderText="编号" HeaderTextAlign="Center" TextAlign="Center">
                    </f:RenderField>
                    <f:RenderField Width="150px" ColumnID="AccidentTypeName" DataField="AccidentTypeName" FieldType="String"
