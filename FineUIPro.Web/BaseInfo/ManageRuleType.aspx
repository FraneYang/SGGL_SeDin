        ...
        <Items>
            <f:Grid ID="Grid1" Title="管理规定分类" ShowHeader="false" EnableCollapse="true" PageSize="10" EnableColumnLines="true"
                ...
                <Columns>
                    ...
                    <f:RenderField Width="100px" ColumnID="ManageRuleTypeCode" DataField="ManageRuleTypeCode" FieldType="String"
                        HeaderText="编号" HeaderTextAlign="Center" TextAlign="Center">
                    </f:RenderField>
                    <f:RenderField Width="300px" ColumnID="ManageRuleTypeName" DataField="ManageRuleTypeName" FieldType="String"
