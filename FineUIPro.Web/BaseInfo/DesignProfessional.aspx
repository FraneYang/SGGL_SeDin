<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DesignProfessional.aspx.cs" Inherits="FineUIPro.Web.BaseInfo.DesignProfessional" %>
    ...
    <form id="form1" runat="server">
        ...
        <f:Panel ID="Panel1" runat="server" Margin="5px" BodyPadding="5px" ShowBorder="false"
            ...
            <Items>
                ...
                <f:Grid ID="Grid1" ShowBorder="true" EnableAjax="false" ShowHeader="false" Title="设计专业定义" EnableCollapse="true"
                    runat="server" BoxFlex="1" DataKeyNames="DesignProfessionalId" AllowCellEditing="true" ForceFit="true"
                    ClicksToEdit="2" DataIDField="DesignProfessionalId" AllowSorting="true" SortField="SortIndex"
                    ...
                    <Toolbars>
                        <f:Toolbar ID="Toolbar1" Position="Top" runat="server" ToolbarAlign="Left">
                            <Items>
                                <f:TextBox ID="txtDesignProfessionalCode" runat="server" Label="专业编号" Width="250px" LabelWidth="110px"
                                    LabelAlign="Right">
                                </f:TextBox>
                    ...
                    <Columns>
                        ...
                        <f:RenderField Width="180px" ColumnID="DesignProfessionalCode" DataField="DesignProfessionalCode"
                            SortField="DesignProfessionalCode" FieldType="String" HeaderText="专业编号" TextAlign="center"
        ...
        <f:Window ID="Window1" Title="设计专业" Hidden="true" EnableIFrame="true" EnableMaximize="true"
