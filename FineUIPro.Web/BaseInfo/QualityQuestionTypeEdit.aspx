<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QualityQuestionTypeEdit.aspx.cs" Inherits="FineUIPro.Web.BaseInfo.QualityQuestionTypeEdit" %>
        ...
        <f:Form ID="SimpleForm1" ShowBorder="false" ShowHeader="false" AutoScroll="true"
            ...
            <Rows>
                <f:FormRow runat="server">
                    <Items>
                        <f:TextBox ID="txtQualityQuestionType" runat="server" Label="质量问题类别"
