<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QualityQuestionType.aspx.cs" Inherits="FineUIPro.Web.BaseInfo.QualityQuestionType" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
<title>质量问题类别定义</title>
    ...
    <form id="form1" runat="server">
        ...
        <f:Panel ID="Panel1" runat="server" Margin="5px" BodyPadding="5px" ShowBorder="false"
            ...
            <Items>
                ...
                <f:Grid ID="Grid1" ShowBorder="true" EnableAjax="false" ShowHeader="false" Title="质量问题类别定义" EnableCollapse="true"
                    runat="server" BoxFlex="1" DataKeyNames="QualityQuestionTypeId" AllowCellEditing="true" ForceFit="true"
                    ClicksToEdit="2" DataIDField="QualityQuestionTypeId" AllowSorting="true" SortField="SortIndex"
                    ...
                    <Toolbars>
                        <f:Toolbar ID="Toolbar1" Position="Top" runat="server" ToolbarAlign="Left">
                            <Items>
                                <f:TextBox ID="txtQualityQuestionType" runat="server" Label="质量问题类别" Width="250px" LabelWidth="120px"
                                    LabelAlign="Right">
                                </f:TextBox>
                    ...
                    <Columns>
                        ...
                        <f:RenderField Width="180px" ColumnID="QualityQuestionType" DataField="QualityQuestionType"
                            SortField="QualityQuestionType" FieldType="String" HeaderText="质量问题类别" TextAlign="Center"
