<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PracticeCertificate.aspx.cs" Inherits="FineUIPro.Web.BaseInfo.PracticeCertificate" %>
...
<body>
    ...
    <f:Panel ID="Panel1" runat="server" Margin="5px" BodyPadding="5px" Title="特岗证书" Layout="HBox"  ShowHeader="false">
        <Items>
            <f:Grid ID="Grid1" Title="执业资格证书" ShowHeader="false" EnableCollapse="true" PageSize="10"  EnableColumnLines="true"
                ShowBorder="true" AllowPaging="true" IsDatabasePaging="true" runat="server" Width="750px" ForceFit="true"
                DataKeyNames="PracticeCertificateId" DataIDField="PracticeCertificateId" OnPageIndexChange="Grid1_PageIndexChange"
                AllowFilters="true" OnFilterChange="Grid1_FilterChange" EnableTextSelection="True">
                <Columns>
                    <f:RowNumberField EnablePagingNumber="true" HeaderText="序号" Width="50px" HeaderTextAlign="Center"
                        TextAlign="Center" />
                    <f:RenderField Width="150px" ColumnID="PracticeCertificateCode" DataField="PracticeCertificateCode"
                        FieldType="String" HeaderText="证书编号" HeaderTextAlign="Center" TextAlign="Center">
                    </f:RenderField>
                    <f:RenderField Width="250px" ColumnID="PracticeCertificateName" DataField="PracticeCertificateName"
            ...
            <f:SimpleForm ID="SimpleForm1" runat="server" ShowBorder="true" ShowHeader="false"
                ...
                <Items>
                    ...
                    <f:TextBox ID="txtPracticeCertificateCode" Label="证书编号" ShowRedStar="true" Required="true"
                        runat="server" LabelAlign="right" AutoPostBack="true" OnTextChanged="TextBox_TextChanged">
                    </f:TextBox>
                    <f:TextBox ID="txtPracticeCertificateName" Label="证书名称" ShowRedStar="true" Required="true"
                        runat="server" LabelAlign="right" AutoPostBack="true" OnTextChanged="TextBox_TextChanged">
                    </f:TextBox>
    ...
    <script type="text/javascript">
        ...
        var txtCodeClientID = '<%= txtPracticeCertificateCode.ClientID %>';
        var txtNameClientID = '<%= txtPracticeCertificateName.ClientID %>';
        ...
        function onGridRowSelect(event, rowId) {
            ...
            F(txtCodeClientID).setValue(rowValue['PracticeCertificateCode']);
            F(txtNameClientID).setValue(rowValue['PracticeCertificateName']);
