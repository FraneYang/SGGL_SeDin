...
<body>
   ...
   <f:PageManager ID="PageManager1" AutoSizePanelID="Panel1" runat="server" />
    <f:Panel ID="Panel1" runat="server" Margin="5px" BodyPadding="5px" Title="分类" Layout="HBox" ShowHeader="false">
        <Items>
            <f:Grid ID="Grid1" Title="分类" ShowHeader="false" EnableCollapse="true" PageSize="10"  EnableColumnLines="true"
