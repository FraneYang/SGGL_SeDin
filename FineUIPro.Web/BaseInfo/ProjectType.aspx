<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProjectType.aspx.cs" Inherits="FineUIPro.Web.BaseInfo.ProjectType" %>
...
<body>
   ...
   <f:PageManager ID="PageManager1" AutoSizePanelID="Panel1" runat="server" />
    <f:Panel ID="Panel1" runat="server" Margin="5px" BodyPadding="5px" Title="单位类型"  ShowHeader="false"
        Layout="HBox">
        <Items>
            <f:Grid ID="Grid1" Title="项目类型" ShowHeader="false" EnableCollapse="true" PageSize="10" EnableColumnLines="true"
                ShowBorder="true" AllowPaging="true" IsDatabasePaging="true" runat="server" Width="750px" ForceFit="true"
                DataKeyNames="ProjectTypeId" DataIDField="ProjectTypeId" OnPageIndexChange="Grid1_PageIndexChange" AllowFilters="true" OnFilterChange="Grid1_FilterChange" EnableTextSelection="True">
                <Columns>
                    <f:RowNumberField EnablePagingNumber="true" HeaderText="序号" Width="50px" HeaderTextAlign="Center" TextAlign="Center"/>
                    <f:RenderField Width="150px" ColumnID="ProjectTypeCode" DataField="ProjectTypeCode" FieldType="String"
                        HeaderText="编号" HeaderTextAlign="Center" TextAlign="Center">
                    </f:RenderField>
                    <f:RenderField Width="250px" ColumnID="ProjectTypeName" DataField="ProjectTypeName" FieldType="String"
            ...
            <f:SimpleForm ID="SimpleForm1" runat="server" ShowBorder="true" ShowHeader="false"
                ...
                <Items>
                    ...
                    <f:TextBox ID="txtProjectTypeName" Label="名称" ShowRedStar="true" Required="true" runat="server"  MaxLength="50"
                        LabelAlign="right" AutoPostBack="true" OnTextChanged="TextBox_TextChanged">
                    </f:TextBox>
    ...
    <script type="text/javascript">
        ...
        var txtCodeClientID = '<%= txtProjectTypeCode.ClientID %>';
        var txtNameClientID = '<%= txtProjectTypeName.ClientID %>';
        ...
        function onGridRowSelect(event, rowId) {
            ...
            F(txtCodeClientID).setValue(rowValue['ProjectTypeCode']);
            F(txtNameClientID).setValue(rowValue['ProjectTypeName']);
