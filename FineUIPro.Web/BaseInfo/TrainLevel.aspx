...
<body>
    ...
    <f:Panel ID="Panel1" runat="server" Margin="5px" BodyPadding="5px" Title="培训级别信息" Layout="HBox"  ShowHeader="false">
        <Items>
            <f:Grid ID="Grid1" Title="培训级别信息" ShowHeader="false" EnableCollapse="true" PageSize="10" ForceFit="true"
                ...
                <Columns>
                    <f:RowNumberField EnablePagingNumber="true" HeaderText="序号" Width="50px" HeaderTextAlign="Center"
                        TextAlign="Center" />
                    <f:RenderField Width="100px" ColumnID="TrainLevelCode" DataField="TrainLevelCode" FieldType="String"
                        HeaderText="编号" HeaderTextAlign="Center" TextAlign="Center">
                    </f:RenderField>
                    <f:RenderField Width="300px" ColumnID="TrainLevelName" DataField="TrainLevelName" FieldType="String"
