    ...
    <f:Panel ID="Panel1" runat="server" Margin="5px" BodyPadding="5px" Title="工作阶段" Layout="HBox"
        ...
        <Items>
            <f:Grid ID="Grid1" Title="工作阶段" ShowHeader="false" EnableCollapse="true" PageSize="10"
                ...
                runat="server" Width="750px" DataKeyNames="WorkStageId" DataIDField="WorkStageId" ForceFit="true"
                OnPageIndexChange="Grid1_PageIndexChange" AllowFilters="true" OnFilterChange="Grid1_FilterChange"
                EnableTextSelection="True">
                <Columns>
                    <f:RowNumberField EnablePagingNumber="true" HeaderText="序号" Width="50px" HeaderTextAlign="Center"
                        TextAlign="Center" />
                    <f:RenderField Width="100px" ColumnID="WorkStageCode" DataField="WorkStageCode" FieldType="String"
                        HeaderText="编号" HeaderTextAlign="Center" TextAlign="Center">
                    </f:RenderField>
                    <f:RenderField Width="350px" ColumnID="WorkStageName" DataField="WorkStageName" FieldType="String"
                        HeaderText="名称" HeaderTextAlign="Center" TextAlign="Left">
                    </f:RenderField>
                    <f:RenderField Width="250px" ColumnID="Remarks" DataField="Remarks" FieldType="String"
