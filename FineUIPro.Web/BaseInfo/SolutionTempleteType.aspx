    ...
    <f:Panel ID="Panel1" runat="server" Margin="5px" BodyPadding="5px" Title="施工方案类型"
        ...
        <Items>
            <f:Grid ID="Grid1" Title="施工方案类型" ShowHeader="false" EnableCollapse="true" PageSize="10"
                EnableColumnLines="true" ShowBorder="true" AllowPaging="true" IsDatabasePaging="true" ForceFit="true"
                runat="server" Width="750px" DataKeyNames="SolutionTempleteTypeCode" DataIDField="SolutionTempleteTypeCode"
                OnPageIndexChange="Grid1_PageIndexChange" AllowFilters="true" OnFilterChange="Grid1_FilterChange"
                EnableTextSelection="True">
                <Columns>
                    <f:RowNumberField EnablePagingNumber="true" HeaderText="序号" Width="50px" HeaderTextAlign="Center"
                        TextAlign="Center" />
                    <f:RenderField Width="100px" ColumnID="SolutionTempleteTypeCode" DataField="SolutionTempleteTypeCode"
                        FieldType="String" HeaderText="编号" HeaderTextAlign="Center" TextAlign="Center">
                    </f:RenderField>
                    <f:RenderField Width="350px" ColumnID="SolutionTempleteTypeName" DataField="SolutionTempleteTypeName"
