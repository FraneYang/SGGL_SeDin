                            ...
                            <div class="headerwrap">
                                <div class="header">
                                    ...
                                    <div class="item-pbig">
                                        ...
                                        <img src="res/index/images/xgglpt.png" alt="施工管理信息平台" />
                                    </div>
                                    <div class="baseInfo">
                                        <ul class="layui-nav navSelect">
                                            ...
                                            <li class="layui-nav-item">
                                                <f:Button runat="server" CssClass="bgbtntop" IconFont="StarO" ToolTip="收藏夹"
                                ...
                                <ul class="up-wrap-ul flex">
                                    ...
                                    <li>
                                        <f:Button runat="server" CssClass="bgbtn" Text="施工综合" OnClick="btnPZHGL_Click" OnClientClick="parent.removeActiveTab();"
                                            EnablePostBack="true" EnableDefaultState="true" EnableDefaultCorner="false" ID="btnPZHGL">
                                        </f:Button>
                                    </li>
                                    <li>
                                        <f:Button runat="server" CssClass="bgbtn" Text="数字工地" OnClick="btnDigitalSite_Click" OnClientClick="parent.removeActiveTab();"
                                            EnablePostBack="true" EnableDefaultState="true" EnableDefaultCorner="false" ID="btnDigitalSite">
                                        </f:Button>
                                    </li>
                                    <li>
                                        <f:Button runat="server" CssClass="bgbtn" Text="大数据中心" OnClick="btnPDigData_Click" OnClientClick="parent.removeActiveTab();"
